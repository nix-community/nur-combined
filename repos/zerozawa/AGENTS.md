...
├── pkgs/                    # 27 exported package definitions
...
The repo currently exports 27 packages from `default.nix`, grouped roughly as:
...
- MCP and developer tools: `agentic-contract`, `context-mode`, `deskbrid`, `mcp-cli`, `pctx`, `wechat-web-devtools-linux`, `wechatbot-mcp`
