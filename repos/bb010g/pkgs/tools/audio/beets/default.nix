...
, bashInteractive, bash-completion, unrar
}:
...
let
  ...
  pluginsWithoutDeps = [
    ...
    "smartplaylist" "spotify" "subsonicupdate" "the" "types" "zero"
  ];
...
in pythonPackages.buildPythonApplication rec {
  pname = "beets";
  version = "1.4.7+${stdenv.lib.substring 0 8 src.rev}";

  src = fetchFromGitHub {
    owner = "beetbox";
    repo = "beets";
    rev = "f54042f194a91b0590d798338a6e43b8a3c4d20d";
    sha256 = "0029z4yrs459y9xi9q7kgp05w3mbr5prk2l62wvydp1a611x7jpx";
  };
