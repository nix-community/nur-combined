...
exec "__OUT__/libexec/tws"  -J-DjtsConfigDir=$HOME/.tws -J-Dawt.useSystemAAFontSettings=lcd -J-Dswing.aatext=true "$@" -J--add-opens -Jjava.desktop/javax.swing=ALL-UNNAMED
