...
}:
{
  ...
  piliplus = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2.0.1.1";
      fetchSubmodules = false;
      sha256 = "sha256-1rOxmmh8gyXUnIK6yBDK/PfxkXEpczG93bNCiDA2YMU=";
    };
    extract = {
      "pubspec.lock" = ./. + "/sha256-1rOxmmh8gyXUnIK6yBDK_PfxkXEpczG93bNCiDA2YMU=/pubspec.lock";
    };
  };
  pixes = {
    pname = "pixes";
  ...
  uosc-danmaku-git = {
    ...
    version = "7814d13127a11e0ce747e65bf8002d3b202d47ce";
    src = fetchFromGitHub {
      owner = "Tony15246";
      repo = "uosc_danmaku";
      rev = "7814d13127a11e0ce747e65bf8002d3b202d47ce";
      fetchSubmodules = false;
      sha256 = "sha256-3duw+2Iukf1/dXrxd0Tm8+J/y2M8rElkCTQvuhcMWRY=";
    };
    date = "2026-03-04";
  };
  wild = {
