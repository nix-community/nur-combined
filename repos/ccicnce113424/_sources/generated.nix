...
}:
{
  ...
  piliplus = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.1.5-pre6";
      fetchSubmodules = false;
      sha256 = "sha256-rn0z8incCdLRgglnuYAoAP/bUnABU1OHWhtW6ezdMCI=";
    };
    "pubspec.lock" = builtins.readFile ./piliplus-1.1.5-pre6/pubspec.lock;
  };
  pixes = {
    pname = "pixes";
    version = "v1.2.0";
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "7de1355f183367a3745aa11f62846193703eccde";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "7de1355f183367a3745aa11f62846193703eccde";
      fetchSubmodules = false;
      sha256 = "sha256-9a2sDX9w88L/O2nsNa42/fj3GmQ1KPrgzNkiiYva25Y=";
    };
    date = "2025-11-17";
  };
  uosc-danmaku = {
