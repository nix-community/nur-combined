...
}:
{
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "8f5797226b3ac3e3241871a65471cfc16087bbab";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "8f5797226b3ac3e3241871a65471cfc16087bbab";
      fetchSubmodules = false;
      sha256 = "sha256-DeH4hW7a0n38uIs7tEjvGGY3Rbtuqjd8Zos6/pE52+s=";
    };
    date = "2025-12-07";
  };
  uosc-danmaku = {
  ...
  uosc-danmaku-git = {
    ...
    version = "8386a99caef2869d7737feb9034d959cada068b8";
    src = fetchFromGitHub {
      owner = "Tony15246";
      repo = "uosc_danmaku";
      rev = "8386a99caef2869d7737feb9034d959cada068b8";
      fetchSubmodules = false;
      sha256 = "sha256-6GedB0x/+qRJ4v8itRt6LWxykTJMM1AlFVQKFQttWIQ=";
    };
    date = "2025-12-06";
  };
  zhuque = {
