...
}:
{
  ...
  motrix-next = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.6.1";
      fetchSubmodules = false;
      sha256 = "sha256-DeqHF36iH2kPi4F7RU5Ipde0lnwGWJqHfu4kz3znexg=";
    };
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./. + "/sha256-DeqHF36iH2kPi4F7RU5Ipde0lnwGWJqHfu4kz3znexg=/src-tauri/Cargo.lock";
      outputHashes = {
  ...
  pixes-git = {
    pname = "pixes-git";
    version = "0b855494dccfd9517b066e03a770d2ceb3265dab";
    src = fetchFromGitHub {
      owner = "wgh136";
      repo = "pixes";
      rev = "0b855494dccfd9517b066e03a770d2ceb3265dab";
      fetchSubmodules = false;
      sha256 = "sha256-l8hbapegLOJln7mZHTCbJ0IzZj5cyAoZf74QqLOw2GY=";
    };
    extract = {
      "pubspec.lock" = ./. + "/sha256-l8hbapegLOJln7mZHTCbJ0IzZj5cyAoZf74QqLOw2GY=/pubspec.lock";
    };
    date = "2026-04-04";
  };
  splayer-git = {
    pname = "splayer-git";
    version = "159f2e4de772f477ca72af3fb99938238f81a32f";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "159f2e4de772f477ca72af3fb99938238f81a32f";
      fetchSubmodules = false;
      sha256 = "sha256-oB7FY1ST0S4fptXfvHruNvHVZ/NAuvaegc7bdBsuXiY=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-oB7FY1ST0S4fptXfvHruNvHVZ_NAuvaegc7bdBsuXiY=/Cargo.lock";
      outputHashes = {
  ...
  uosc-danmaku-git = {
    ...
    version = "9ceefc02bc3f193db66c6e326141b29bd3d6748c";
    src = fetchFromGitHub {
      owner = "Tony15246";
      repo = "uosc_danmaku";
      rev = "9ceefc02bc3f193db66c6e326141b29bd3d6748c";
      fetchSubmodules = false;
      sha256 = "sha256-a+FXngRimggYGGMt/GMHVaX9wjgXJr1dbra83L3qbq0=";
    };
    date = "2026-04-03";
