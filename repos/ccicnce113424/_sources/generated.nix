...
}:
{
  ...
  piliplus = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.1.5.2";
      fetchSubmodules = false;
      sha256 = "sha256-fTTaimA+cT60XTgTdjrljWvDJwLfRO/bxJ2KcVGFIa0=";
    };
    "pubspec.lock" = builtins.readFile ./piliplus-1.1.5.2/pubspec.lock;
  };
  pixes = {
    pname = "pixes";
    version = "v1.2.0";
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "2173f19642c05327fd23a08ade580ba1dfab2454";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "2173f19642c05327fd23a08ade580ba1dfab2454";
      fetchSubmodules = false;
      sha256 = "sha256-Y+GI+wkleQR7LoRVAcyDqwAZRe+8n+kPSnX6T53I6qg=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./splayer-git-2173f19642c05327fd23a08ade580ba1dfab2454/Cargo.lock;
      outputHashes = {
