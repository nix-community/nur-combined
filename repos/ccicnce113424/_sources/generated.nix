...
}:
{
  ...
  motrix-next-beta = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.9.3-beta.3";
      fetchSubmodules = false;
      sha256 = "sha256-Bl3Jv27Ceh7oVhH9GI/cVrKj+mQUdDQErPKnX0kyImU=";
    };
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./. + "/sha256-Bl3Jv27Ceh7oVhH9GI_cVrKj+mQUdDQErPKnX0kyImU=/src-tauri/Cargo.lock";
      outputHashes = {
  ...
  piliplus = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2.0.7.2";
      fetchSubmodules = false;
      sha256 = "sha256-yLbivIJHYtRfmlAeR78GY6+9vKZtLePc0uID/JxgHng=";
    };
    extract = {
      "pubspec.lock" = ./. + "/sha256-yLbivIJHYtRfmlAeR78GY6+9vKZtLePc0uID_JxgHng=/pubspec.lock";
    };
  };
  pixes = {
    pname = "pixes";
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "3380dcd37cf89eb03d0f6c972adbb6bce66ca955";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "3380dcd37cf89eb03d0f6c972adbb6bce66ca955";
      fetchSubmodules = false;
      sha256 = "sha256-ZUOD0JzXvxUrjbC/k5NHOxUvtmtrspOeBYj4qJ4zujg=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-ZUOD0JzXvxUrjbC_k5NHOxUvtmtrspOeBYj4qJ4zujg=/Cargo.lock";
      outputHashes = {
  ...
  splayer-next-dev = {
    ...
    version = "f396e11371515f73b07e97b760fff21a2a947ad4";
    src = fetchFromGitHub {
      owner = "SPlayer-Dev";
      repo = "SPlayer-Next";
      rev = "f396e11371515f73b07e97b760fff21a2a947ad4";
      fetchSubmodules = false;
      sha256 = "sha256-zAd71lD8G6b/MCOWM1HxFakI3VnQ4SlSHLgAhP8eJnI=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-zAd71lD8G6b_MCOWM1HxFakI3VnQ4SlSHLgAhP8eJnI=/Cargo.lock";
      outputHashes = {
