...
}:
{
  ...
  piliplus = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.1.5-pre8";
      fetchSubmodules = false;
      sha256 = "sha256-Co0kW+SX7I01A6GVI9IdTzvhMePr10oyjexkfbnxoQY=";
    };
    "pubspec.lock" = builtins.readFile ./piliplus-1.1.5-pre8/pubspec.lock;
  };
  pixes = {
    pname = "pixes";
    version = "v1.2.0";
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "69ae3382cdbb9414544a55e3f42b8c2b662f699c";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "69ae3382cdbb9414544a55e3f42b8c2b662f699c";
      fetchSubmodules = false;
      sha256 = "sha256-O4hdkRx4GlSTZGM1MZfqsPLFf0mkqrHEbE4sUgscexs=";
    };
    date = "2025-11-28";
  };
  uosc-danmaku = {
  ...
  uosc-danmaku-git = {
    ...
    version = "014aa10fd01112eb7fc8d054145e43c21cedf58a";
    src = fetchFromGitHub {
      owner = "Tony15246";
      repo = "uosc_danmaku";
      rev = "014aa10fd01112eb7fc8d054145e43c21cedf58a";
      fetchSubmodules = false;
      sha256 = "sha256-NHSSFhdsxxyhkmU8ruKguclOu9vFojNgBz9jWZ+a6cI=";
    };
    date = "2025-11-27";
  };
  zhuque = {
