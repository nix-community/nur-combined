...
}:
{
  amgcl = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-gODU6U5uwiZTt70wQv19bA1xJHymxdUpn3OtIIesOXw=";
    };
  };
  autobean-format = {
  ...
  rime-ice-modular = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-6a85fs0Y5O55ZO7DC0onoPS9/QKFnAUmd6KNzLOkSs0=";
    };
  };
  rime-prelude = {
    pname = "rime-prelude";
  ...
  xdg = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.17.0";
      fetchSubmodules = false;
      sha256 = "sha256-+gTXSkGEW8a/2kv61zefKjdcIzcfRKmcb8KN8PcP/Tw=";
    };
  };
  xdg-user-dirs = {
    pname = "xdg-user-dirs";
