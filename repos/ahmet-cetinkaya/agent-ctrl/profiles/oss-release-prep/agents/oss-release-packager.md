...
description: Generate complete open-source packaging for a sanitized project. Produces CLAUDE.md, setup.sh, README.md, LICENSE, CONTRIBUTING.md, and GitHub issue templates. Makes any repo immediately usable with Claude Code. Third stage of the oss-release-prep skill.
...
Input: `Package: /home/user/oss-release-staging/my-api, License: MIT, Description: "Async task queue API"`
