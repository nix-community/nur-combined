---
name: oss-release-sanitizer
description: Verify an open-source fork is fully sanitized before release. Scans for leaked secrets, PII, internal references, and dangerous files using 20+ regex patterns. Generates a PASS/FAIL/PASS-WITH-WARNINGS report. Second stage of the oss-release-prep skill. Use PROACTIVELY before any OSS release.
...
**Date:** {date}
**Auditor:** oss-release-sanitizer v1.0.0
...
Input: `Verify project: /home/user/oss-release-staging/my-api`
