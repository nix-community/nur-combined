{pkgs ? import <nixpkgs> {}}: rec {
  ...
  # Backports
  wlroots_0_17 =
    if pkgs ? wlroots_0_17
    then pkgs.wlroots_0_17
    else
  ...
  # Variants
  fastfetchMinimal =
    (fastfetch.overrideAttrs (prevAttrs: {
  ...
  gtatoolFull =
    (gtatool.overrideAttrs (prevAttrs: {
  ...
  libtgdFull =
    (libtgd.overrideAttrs (prevAttrs: {
      pname = "${prevAttrs.pname}-full";
      meta =
        prevAttrs.meta
        // {
