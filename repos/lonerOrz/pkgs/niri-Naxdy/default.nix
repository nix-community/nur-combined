...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "Naxdy";
    repo = "niri";
    rev = "92e55257536d384076731f151d39ece6488224dc";
    hash = "sha256-WRJgSa6XGYuz2GtIwxSis1iA+ZkLA0hauGvjCY7Aznw=";
  };

  cargoHash = "sha256-KN5hXHfmVScBtzQLyrNz7YoTy7WY4fiGDnzOlreG6i8=";
