...
let
  pname = "gemini-cli";
  version = "0.13.0-nightly.20251103.9187f6f6";
  srcHash = "sha256-hj4Ba+O+Ti6e3i1QDeMoJmFuPcsjT/zySkAPoYl5S+Y=";
  npmDepsHash = "sha256-KbyPmbmUYyU9Z3MFx/ctqvMOXF7xWnTfQuOjeOLrhGA=";
