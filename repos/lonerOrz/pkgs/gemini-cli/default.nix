...
let
  pname = "gemini-cli";
  version = "0.10.0-nightly.20251015.996c9f59";
  srcHash = "sha256-6sSPqYcTXHxkfJMXrBAftH+gPtkvKPomew0dAkgb3rs=";
  npmDepsHash = "sha256-/hqkF7m8kQnHf3kq6EMzmIiayxJnADvbLE/hwEq7uOc=";
