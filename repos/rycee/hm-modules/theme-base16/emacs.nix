...
let
  ...
  template = builtins.fetchurl {
    url = "https://raw.githubusercontent.com/base16-project/base16-emacs/26b84fc93505219517a512eb01e6370365174989/templates/default.mustache";
  ...
  themeFile = pkgs.runCommandLocal "base16-hm-theme" { } ''
    ...
    sed '${
      concatStringsSep ";" (
        mapAttrsToList (n: v: "s/#{{${n}-hex}}/#${v.hex.rgb}/g") colors ++ [ "s/{{scheme-slug}}/hm/g" ]
      )
