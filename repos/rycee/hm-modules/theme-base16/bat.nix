...
let
  ...
  template = builtins.fetchurl {
    url = "https://raw.githubusercontent.com/chriskempson/base16-textmate/cab66929126a14acafe37cf9c24c9e700716cd5a/templates/default.mustache";
    sha256 = "08cz7drc8b31xc51b84ziibfchkkx0dbli3976s2zm7x8m2c6fsg";
  };

  themeFile = pkgs.runCommandLocal "hm-bat-theme" { } ''
    sed '${
      concatStrings (mapAttrsToList (n: v: "s/#{{${n}-hex}}/#${v.hex.rgb}/;") colors)
    }' ${template} > $out
  '';
