_ghostty() {
  ...
  _handle_config() {
    ...
    case "$prev" in
      ...
      --split-preserve-zoom) mapfile -t COMPREPLY < <( compgen -W "navigation no-navigation" -- "$cur" ); _add_spaces ;;
      ...
      --shell-integration) mapfile -t COMPREPLY < <( compgen -W "none detect bash elvish fish nushell zsh" -- "$cur" ); _add_spaces ;;
      ...
      --macos-dock-drop-behavior) mapfile -t COMPREPLY < <( compgen -W "new-tab new-window" -- "$cur" ); _add_spaces ;;
