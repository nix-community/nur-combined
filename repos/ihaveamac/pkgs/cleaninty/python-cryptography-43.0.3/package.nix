...
buildPythonPackage rec {
  pname = "cryptography";
  version = "43.0.3"; # Also update the hash in vectors.nix
  pyproject = true;
  ...
  src = fetchFromGitHub {
    ...
    repo = "cryptography";
    tag = version;
    hash = "sha256-Tocm/yAA2REGpbH+8w5QA11E/yDQmgn7AuCY4pdTH9o=";
  };

  cargoDeps = rustPlatform.fetchCargoVendor {
    inherit pname version;
    src = "${src}/src/rust";
    hash = "sha256-e6V8QJAiP1EJAJxU+KchJBIyz5wUTxxK5NtXqmlVHII=";
  };

  postPatch = ''
    cp src/rust/Cargo.lock .
