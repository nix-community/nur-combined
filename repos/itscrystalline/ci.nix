...
with builtins; let
  ...
  isBuildable = p: let
    ...
    supportedPlatform = platforms == null || builtins.elem pkgs.stdenv.hostPlatform.system platforms;
    badPlatforms = p.meta.badPlatforms or [];
    notBadPlatform = !builtins.elem pkgs.stdenv.hostPlatform.system badPlatforms;
  in
