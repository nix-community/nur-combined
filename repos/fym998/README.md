...
| [wallpaper-fetcher](./pkgs/by-name/wallpaper-fetcher.nix#L38) | 0.2.6 | Small cli program to automatically download and set the daily Bing wallpaper on Windows, Linux or Mac. | [Link](https://pypi.org/project/wallpaper-fetcher) |
