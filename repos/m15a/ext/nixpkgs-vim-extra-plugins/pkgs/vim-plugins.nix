...

{
  ...
  guihua-lua = buildVimPluginFrom2Nix {
    ...
    version = "2022-10-05";
    src = fetchurl {
      url = "https://github.com/ray-x/guihua.lua/archive/5d7f45500ece68832b2d2f0b9592a00b7cacd0b6.tar.gz";
      sha256 = "0s5375x00g2v2pjc5gm4dbp1pdvq1w6isqcj5cdg9m57cmkh15py";
    };
    meta = with lib; {
