...

{
  ...
  overseer-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2022-09-08";
    src = fetchurl {
      url = "https://github.com/stevearc/overseer.nvim/archive/70df32b79c162742bbf0940edcf3049d424b69cd.tar.gz";
      sha256 = "0lsfi15b958qw9bd080kicwnkslxi8zd3prlqgh1n3787g38c96i";
    };
    meta = with lib; {
