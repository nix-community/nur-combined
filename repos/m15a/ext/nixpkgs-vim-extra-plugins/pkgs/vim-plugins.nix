...

{
  ...
  catppuccin = buildVimPluginFrom2Nix {
    ...
    version = "2022-10-23";
    src = fetchurl {
      url = "https://github.com/catppuccin/nvim/archive/44de024d501fe0f2709bef83ad800f51cf9d90a1.tar.gz";
      sha256 = "0y45wkx2rsic6dpr2bzdrsdsdka1yilzi1pcw506gx2qlg56yjnf";
    };
    meta = with lib; {
