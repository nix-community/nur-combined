...

{
  ...
  nvim-completion = buildVimPluginFrom2Nix {
    ...
    version = "2022-09-04";
    src = fetchurl {
      url = "https://github.com/noib3/nvim-completion/archive/2ab50208ae1ccc1add73fb170f2e7ea0b32bf8a8.tar.gz";
      sha256 = "0bvqj881qrm45w4fls48kwl7gaznnkkr4lj5b881lpnxq992ixi6";
    };
    meta = with lib; {
