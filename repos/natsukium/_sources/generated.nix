...
}:
{
  ...
  emacs-plus = {
    pname = "emacs-plus";
    version = "ed37c1f9adc38f4df71c5b7efb328712c331e86d";
    src = fetchFromGitHub {
      owner = "d12frosted";
      repo = "homebrew-emacs-plus";
      rev = "ed37c1f9adc38f4df71c5b7efb328712c331e86d";
      fetchSubmodules = false;
      sha256 = "sha256-TvHbYqLolIX/cTkG3hi4hGMrpTAeiqarGVnIgio8PWw=";
    };
    date = "2026-03-02";
  };
  hammerspoon = {
  ...
  skills-ref = {
    pname = "skills-ref";
    version = "f019a02dbbb1302217c4b4a14557d6384d9ace9a";
    src = fetchFromGitHub {
      owner = "agentskills";
      repo = "agentskills";
      rev = "f019a02dbbb1302217c4b4a14557d6384d9ace9a";
      fetchSubmodules = false;
      sha256 = "sha256-juWyT2YrW3nZ9Z8xcXv6OIRQjr4dQgWqvLLjVcEoW2w=";
    };
    date = "2026-03-02";
  };
  skkeleton = {
  ...
  zen-browser = {
    ...
    version = "1.19b";
    src = fetchurl {
      url = "https://github.com/zen-browser/desktop/releases/download/1.19b/zen.macos-universal.dmg";
      sha256 = "sha256-BvJ3O1k1JIYPLT5fbx3K487kBGZwTmQDmGhwwCuiG4w=";
    };
  };
}
