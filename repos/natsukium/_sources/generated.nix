...
}:
{
  ...
  emacs-plus = {
    pname = "emacs-plus";
    version = "83503d459ffb6c018e8f33172f498fd9c9d9f262";
    src = fetchFromGitHub {
      owner = "d12frosted";
      repo = "homebrew-emacs-plus";
      rev = "83503d459ffb6c018e8f33172f498fd9c9d9f262";
      fetchSubmodules = false;
      sha256 = "sha256-djHkTt+1HFGM0p0FujTEPrD13QJUmCj4sU8i2H5lpz4=";
    };
    date = "2026-04-25";
  };
  hammerspoon = {
  ...
  zen-browser = {
    ...
    version = "1.19.9b";
    src = fetchurl {
      url = "https://github.com/zen-browser/desktop/releases/download/1.19.9b/zen.macos-universal.dmg";
      sha256 = "sha256-1JLCS0XUvDWN9bkq55vkBvKHnMRmINEYUu5p5QGsv/E=";
    };
  };
}
