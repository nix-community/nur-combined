...
wemeet =
  define $
    package "wemeet"
      ...
      `fetchUrl` url
  where
    url (Version v) = "https://updatecdn.meeting.qq.com/OTRhY2YwZTUtMzE5Ni00NDQyLTg0MTMtOTBjYzQzNzcxYTQz/TencentMeeting_0300000000_" <> v <> "_x86_64_default.publish.deb"
