...
wemeet =
  define $
    package "wemeet"
      ...
      `fetchUrl` url
  where
    url (Version v) = "https://updatecdn.meeting.qq.com/MTZlNjg4ZjctOTAwMS00NDg2LWE3ZjMtMjNhZjBmODk3ZTIz/TencentMeeting_0300000000_" <> v <> "_x86_64_default.publish.deb"
