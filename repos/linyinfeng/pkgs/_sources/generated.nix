...
}:
{
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.18.41-linux-260807T082820Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.18.41-linux-260807T082820Z";
      fetchSubmodules = false;
      sha256 = "sha256-1wZ83givAFR9Y1wYWZTjFcVD78mpkT1RGhbs/l43jYk=";
    };
  };
  ...
  v86 = {
    pname = "v86";
    version = "f3d4472a9c934b9ad78a311f5849ba711a296d23";
    src = fetchgit {
      url = "https://github.com/copy/v86.git";
      rev = "f3d4472a9c934b9ad78a311f5849ba711a296d23";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-XKi5/BkThdoxzI6SWjub6u5mI+UtiaSy+O4GqVTDBsc=";
    };
    date = "2026-08-09";
  };
  vlmcsd = {
