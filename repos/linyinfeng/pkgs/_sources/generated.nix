...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  telegram-send = {
    pname = "telegram-send";
    version = "1f53dbc64c71349b347c93d3a8de41051c7fc506";
    src = fetchgit {
      url = "https://github.com/rahiel/telegram-send.git";
      rev = "1f53dbc64c71349b347c93d3a8de41051c7fc506";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-jzxstJNOcMfRqZpgnIR/6myszkW6LCxJkSORQdOLUhs=";
    };
    date = "2023-10-07";
  };
  tg-send = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-PVqfoboYiCwZT+upwSilraaPKO6zV4odlrLIJJrm4XQ=";
    };
    date = "2023-10-02";
  };
  yacd = {
