...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  aws-sigv4-proxy = {
    ...
    version = "5770ebf7f95b58bad15546a2d1827040d61ec611";
    src = fetchgit {
      url = "https://github.com/awslabs/aws-sigv4-proxy.git";
      rev = "5770ebf7f95b58bad15546a2d1827040d61ec611";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-qmRs/LDaD9SDTMBwTBX7L/X7rSYxEA2oEU3SK9RBFvE=";
    };
    date = "2024-01-19";
  };
  cowrie = {
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.11.0";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.11.0/app-x86_64.asar";
      sha256 = "sha256-uhKcrd5rHEN1gXVY6hYbpmteQE5ySW7bZKnsZfx3y/4=";
    };
  };
  mstickereditor = {
  ...
  plugin-git = {
    pname = "plugin-git";
    version = "97ec249926f0dc8b93a40e45c9aa95e788872272";
    src = fetchgit {
      url = "https://github.com/jhillyerd/plugin-git";
      rev = "97ec249926f0dc8b93a40e45c9aa95e788872272";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ZFjm9FgYuIeM6y05ok0T2XoJV2+6DrQUiEwSB1kHkoM=";
    };
    date = "2024-01-10";
  };
  pyim-greatdict = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-eYtpgduf8Oru8wHeb0Goi+38wZABJsz+tTS5uUOlWgg=";
    };
    date = "2024-01-22";
  };
  yacd = {
