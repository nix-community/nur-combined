...
}:
{
  ...
  baibot = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.15.0";
      fetchSubmodules = false;
      sha256 = "sha256-hG21mstmonZzIxcsPYS/Z0jTLHLZ07iwLY65X9EpStE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-hG21mstmonZzIxcsPYS_Z0jTLHLZ07iwLY65X9EpStE=/Cargo.lock";
      outputHashes = {
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.18.15-linux-260310T050801Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.18.15-linux-260310T050801Z";
      fetchSubmodules = false;
      sha256 = "sha256-32/WDRSQN0tQsevvYJcWpPu/lP0px8h+rL7N4EL+fIw=";
    };
  };
  ...
  moe-koe-music = {
    ...
    version = "v1.6.0";
    src = fetchurl {
      url = "https://github.com/iAJue/MoeKoeMusic/releases/download/v1.6.0/MoeKoe_Music_v1.6.0.AppImage";
      sha256 = "sha256-IRpSyQ1hWKBoH5doP4i/dXAgRS/fCmkHzuTv5LUMCHo=";
    };
  };
  mstickereditor = {
  ...
  rime-ice = {
    ...
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-qNOHUKzKd99QJ7ka8TzXJ6ubTuj8qxNTFdUgVRp6w64=";
    };
    date = "2026-03-17";
  };
  rime-loengfan = {
