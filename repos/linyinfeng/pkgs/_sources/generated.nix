...
}:
{
  aws-sigv4-proxy = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-RMLumWYHfxNxWt6UJzYvaAQX0PWltJrWcPZXrhrdymM=";
    };
  };
  baibot = {
    pname = "baibot";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.27.0";
      fetchSubmodules = false;
      sha256 = "sha256-43gRZxidnSlFsurfuU1cHqU0cBDeWwpN3bydLSgIVUk=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-43gRZxidnSlFsurfuU1cHqU0cBDeWwpN3bydLSgIVUk=/Cargo.lock";
      outputHashes = {
  ...
  codestable = {
    pname = "codestable";
    version = "19c796de5990973a9e5d44aa9536d90513e37b5c";
    src = fetchgit {
      url = "https://github.com/liuzhengdongfortest/CodeStable";
      rev = "19c796de5990973a9e5d44aa9536d90513e37b5c";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-bCphi9JAoVlRYqHNEJ3c5Fk8He6uaAnS2t4yt+ZVcyM=";
    };
    date = "2026-08-18";
  };
  cowrie = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.0.15";
      fetchSubmodules = false;
      sha256 = "sha256-kmFq89AqG7ryjJ3fEO909lQxg/2TiPWmnwAMta2oEo8=";
    };
  };
  dot-tar = {
    pname = "dot-tar";
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.18.50-linux-260910T063458Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.18.50-linux-260910T063458Z";
      fetchSubmodules = false;
      sha256 = "sha256-aiLQERCGDQtdYF7TBW2BDWn5hAAIRs6qdKgVJRfjXVU=";
    };
  };
  ...
  rime-essay = {
    pname = "rime-essay";
    version = "e2652ea18609a879eae3e87db5d25b7fbc1a4f93";
    src = fetchgit {
      url = "https://github.com/rime/rime-essay.git";
      rev = "e2652ea18609a879eae3e87db5d25b7fbc1a4f93";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Zz/qRPZ7rIidDh1aZXtrJDcflNSxW1l5usSdFw/7GUw=";
    };
    date = "2026-09-18";
  };
  rime-ice = {
    pname = "rime-ice";
    version = "9e66b0729083b37d217312294f6d516c8d7234be";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-8qWW1n6wbWJOPf0XE+0BTj4fgZRH1gwIyPtWrJsXcB8=";
    };
    date = "2026-09-19";
  };
  rime-loengfan = {
  ...
  rime-terra-pinyin = {
    ...
    version = "723e51bc266cf9464530c1ddedb856aa18e3da34";
    src = fetchgit {
      url = "https://github.com/rime/rime-terra-pinyin.git";
      rev = "723e51bc266cf9464530c1ddedb856aa18e3da34";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-NS+UurPe7VglcImgsY/X+MH9g7opF7vsw8vVWKbUt3M=";
    };
    date = "2026-09-18";
  };
  rime-wubi = {
  ...
  v86 = {
    pname = "v86";
    version = "5f9a90f2be01243dd0ea4fe014cce12686cf3ced";
    src = fetchgit {
      url = "https://github.com/copy/v86.git";
      rev = "5f9a90f2be01243dd0ea4fe014cce12686cf3ced";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-ZYfvJ5Py7j7m95G2sKqP6iUw+t0XOzMVggRTLIti5v8=";
    };
    date = "2026-09-20";
  };
  vlmcsd = {
