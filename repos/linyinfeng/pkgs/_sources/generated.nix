...
}:
{
  ...
  baibot = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.8.3";
      fetchSubmodules = false;
      sha256 = "sha256-cTbtJlKCRBO2hMsWbzRcDt/HNT0AUMrLOV9//1WU+u4=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-cTbtJlKCRBO2hMsWbzRcDt_HNT0AUMrLOV9__1WU+u4=/Cargo.lock";
      outputHashes = {
  ...
  cowrie = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.9.0";
      fetchSubmodules = false;
      sha256 = "sha256-WsxgkefqnN6DSbejxKTDAXigKIy3HuQ6vTIAtSGK/VI=";
    };
  };
  dot-tar = {
    pname = "dot-tar";
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.12.58-linux-251114T045655Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.12.58-linux-251114T045655Z";
      fetchSubmodules = false;
      sha256 = "sha256-fnJQf1LDUEUSsfjY7pRQp/+eCvucdSCTCqi8j1zV5IQ=";
    };
  };
  ...
  rime-cantonese = {
    ...
    version = "6907808ffbf9e47e3a4775f9fcdc31a50670547d";
    src = fetchgit {
      url = "https://github.com/rime/rime-cantonese.git";
      rev = "6907808ffbf9e47e3a4775f9fcdc31a50670547d";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-IdzYAwHyacGlRiJ/yiY38t+djJ6Pw2wMmrjNj+VFZWE=";
    };
    date = "2025-11-27";
  };
  rime-double-pinyin = {
