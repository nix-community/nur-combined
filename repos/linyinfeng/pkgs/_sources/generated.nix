...
}:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.12.6";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.12.6/app-x86_64.asar";
      sha256 = "sha256-w6Ey/TQzhCsB1Zm4PLhNXrV1MKVJL0zVFeBw2uR9I4Y=";
    };
  };
  linux-intel-lts = {
  ...
  waybar-git = {
    pname = "waybar-git";
    version = "99971556178ae504b7ba7ab559952f781925f7da";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-1UesUSGvuJPx+DPXVwXDs6PxsRu+wipLmtXuSQRfrdY=";
    };
    date = "2024-07-01";
  };
  yacd = {
