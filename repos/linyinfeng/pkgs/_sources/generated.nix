...
}:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.12.13";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.12.13/app-x86_64.asar";
      sha256 = "sha256-VSraW5hz6PZ6IZJBoMIxmV+YSEmfanQy98TZ4eQtvkc=";
    };
  };
  linux-intel-lts = {
    pname = "linux-intel-lts";
    version = "lts-v6.6.44-linux-240819T072811Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.6.44-linux-240819T072811Z";
      fetchSubmodules = false;
      sha256 = "sha256-5D1Ex0NZidmQA03o8Hey9RNWzGp6aw6LHbSnylPxFOI=";
    };
  };
