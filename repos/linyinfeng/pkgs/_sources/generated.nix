...
}:
{
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.18.23-linux-260422T014959Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.18.23-linux-260422T014959Z";
      fetchSubmodules = false;
      sha256 = "sha256-vaYnHQ51DgUYhqXxOnLoMlj2R72yz3fDUkYZxG2ktx0=";
    };
  };
  ...
  v86 = {
    pname = "v86";
    version = "b37d99544b7aaa8a48d7ac8fd8f75de13367b880";
    src = fetchgit {
      url = "https://github.com/copy/v86.git";
      rev = "b37d99544b7aaa8a48d7ac8fd8f75de13367b880";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-NynHZpi8MCl9wuYolFMqWhT3MNr4MeQ3Swqt/k4a2KU=";
    };
    date = "2026-04-29";
  };
  vlmcsd = {
