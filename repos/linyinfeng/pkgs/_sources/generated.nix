...
}:
{
  ...
  baibot = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.7.0";
      fetchSubmodules = false;
      sha256 = "sha256-fY4kphzkoaEVGt5fkb93PsdY8U111lM2P2I19rUGMdo=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./baibot-v1.7.0/Cargo.lock;
      outputHashes = {
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.12.24-linux-250501T040919Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.12.24-linux-250501T040919Z";
      fetchSubmodules = false;
      sha256 = "sha256-yLmCnr+merYnRw5huhNVE6ryRnrZHrn+3DlDkH5dK1I=";
    };
  };
