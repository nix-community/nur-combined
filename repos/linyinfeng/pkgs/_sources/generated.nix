...
}:
{
  ...
  baibot = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.19.3";
      fetchSubmodules = false;
      sha256 = "sha256-Fr1CvFocb/VAYQGykXXZ6CCfvC31bKB/tr1aoA4oIME=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-Fr1CvFocb_VAYQGykXXZ6CCfvC31bKB_tr1aoA4oIME=/Cargo.lock";
      outputHashes = {
  ...
  rime-cangjie = {
    pname = "rime-cangjie";
    version = "d3ea6bf24e0c9cf593788210945226582bcb4bc9";
    src = fetchgit {
      url = "https://github.com/rime/rime-cangjie.git";
      rev = "d3ea6bf24e0c9cf593788210945226582bcb4bc9";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-KOaDUrp1nrTl4tAHNpjVlU1JiizkuL1Fg+0Y7muDcHk=";
    };
    date = "2026-05-08";
  };
  rime-cantonese = {
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "806d85fb95be3b5c8a836b242ed87b07bbbba878";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "806d85fb95be3b5c8a836b242ed87b07bbbba878";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-uk3MoYwZaxndPiYXGbSd+mG3ATDYYNCXCAOEINwNgd4=";
    };
    date = "2026-05-31";
  };
  rime-loengfan = {
  ...
  rime-quick = {
    pname = "rime-quick";
    version = "82b95c7de8124dae27a8e6ee17ee9e991f4ec244";
    src = fetchgit {
      url = "https://github.com/rime/rime-quick.git";
      rev = "82b95c7de8124dae27a8e6ee17ee9e991f4ec244";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-LoVSOKrPBWeMw254KxtT0AdhQHORDkb43eEh6dlfqC4=";
    };
    date = "2026-05-13";
  };
  rime-stroke = {
