...
}:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.12.23";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.12.23/app-x86_64.asar";
      sha256 = "sha256-WMHx+lSLCFygguv/QeahPxpxCpYI+PTAkALrs6sxPRU=";
    };
  };
  linux-intel-lts = {
    pname = "linux-intel-lts";
    version = "lts-v6.6.58-linux-241025T055939Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.6.58-linux-241025T055939Z";
      fetchSubmodules = false;
      sha256 = "sha256-nv4vHaCGYvkg3ed3uTGfBU1uQCukKsWJU9sT/KBv5sI=";
    };
  };
  ...
  rime-cantonese = {
    ...
    version = "9425b03f914300f2667bc7ce3f9a3a916221f220";
    src = fetchgit {
      url = "https://github.com/rime/rime-cantonese.git";
      rev = "9425b03f914300f2667bc7ce3f9a3a916221f220";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-ebmG6/9GKbNkA6fJk0PA54eF6szBpDrDJsZvPq2Mq+0=";
    };
    date = "2024-09-19";
  };
  rime-double-pinyin = {
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "7c7abd4a52c0941c2aac4d44e907f8addf46ff89";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "7c7abd4a52c0941c2aac4d44e907f8addf46ff89";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-sUjQ/FoFvRy99hyP8Z30A15C4x1qS/M8eNSk2LyN2Uk=";
    };
    date = "2024-10-30";
  };
  rime-loengfan = {
