...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.6";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.6/Clash.for.Windows-0.20.6-x64-linux.tar.gz";
      sha256 = "sha256-nYLZVfQgRL0dtOm9GytpNy2NWrZcXoSuZ6oSGx/R7pQ=";
    };
  };
  ...
  wemeet = {
    ...
    version = "3.11.0.401";
    src = fetchurl {
      url = "https://updatecdn.meeting.qq.com/cos/1ee0de1d3bf77c3dcfbcf47fea67f5dc/TencentMeeting_0300000000_3.11.0.401_x86_64_default.publish.deb";
      sha256 = "sha256-sRif4YTd0m6XUY3p4jYVqJEtqji5VXzVWDQn+lRVGFQ=";
    };
  };
  yacd = {
    pname = "yacd";
