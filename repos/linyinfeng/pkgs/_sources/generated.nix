...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.10.9";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.10.9/app-x86_64.asar";
      sha256 = "sha256-3Ek5MrpXigIFZD+1C+XWwIe9XSKZ7bT3UcV9BxnyoYk=";
    };
  };
  mstickereditor = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-4uRQndEEpv7VFfxWl+gsZjc2Jk4UjRPLE/Q6aM3A1PY=";
    };
    date = "2023-11-06";
  };
  yacd = {
