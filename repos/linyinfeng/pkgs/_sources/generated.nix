...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.32";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.32/Clash.for.Windows-0.20.32-x64-linux.tar.gz";
      sha256 = "sha256-7KCCXwUCW3MtyrSAHRCls6WBj3qu+nVaaUgL41zHi3U=";
    };
  };
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.10.1";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.10.1/app-x86_64.asar";
      sha256 = "sha256-t/UqV87i29mrtaS2DLvcK4o20zt4Ax1qOaJDdjBBzzg=";
    };
  };
  mstickereditor = {
