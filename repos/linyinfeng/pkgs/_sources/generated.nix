...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.8.8";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.8.8/app-x86_64.asar";
      sha256 = "sha256-OmF7MHsZ6I2I+5w5wibFZrFqCn4T5W1aMJWW01Z79FA=";
    };
  };
  plugin-bang-bang = {
  ...
  plugin-git = {
    pname = "plugin-git";
    version = "74450ffecf41a0dc4862143739840d0df52a5393";
    src = fetchgit {
      url = "https://github.com/jhillyerd/plugin-git";
      rev = "74450ffecf41a0dc4862143739840d0df52a5393";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-9kY+E2JWAYqPF5T1eQZsP8kpLUT1UeP6YQt5uaQ5Vnk=";
    };
    date = "2023-02-19";
  };
  replay-fish = {
