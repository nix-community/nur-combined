...
}:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.12.22";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.12.22/app-x86_64.asar";
      sha256 = "sha256-dRs2IQn2NrJaSqKqK9u/1KtMgcPnyYTWxfjYsmVzqs0=";
    };
  };
  linux-intel-lts = {
  ...
  plugin-git = {
    pname = "plugin-git";
    version = "868190ae8a81b6ed5dccdbbc82b0f6e6ecb578a4";
    src = fetchgit {
      url = "https://github.com/jhillyerd/plugin-git";
      rev = "868190ae8a81b6ed5dccdbbc82b0f6e6ecb578a4";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Jvj3KSgCk1jqTEsQ5ICkBb4Rr0Xt4UYykl4xH4MAnN0=";
    };
    date = "2024-09-23";
  };
  pyim-greatdict = {
