...
}:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.12.9";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.12.9/app-x86_64.asar";
      sha256 = "sha256-AgGhfZSiiIKjiwFfMW94mrLHaTTtwEQYn/K4/wCW3wM=";
    };
  };
  linux-intel-lts = {
    pname = "linux-intel-lts";
    version = "lts-v6.6.41-linux-240722T155543Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.6.41-linux-240722T155543Z";
      fetchSubmodules = false;
      sha256 = "sha256-3sVROVHP9mQubzJ2Nd/lzlNFbtnHg+kW4vkx0pclBRY=";
    };
  };
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "f7423ecfa19bf3db875bcc9f3b2ba8e87f93249f";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "f7423ecfa19bf3db875bcc9f3b2ba8e87f93249f";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-IKzuVH3aAPmhhiFObpgMpPlCDYkFNSnR9XyLOHHlc+8=";
    };
    date = "2024-07-26";
  };
  rime-loengfan = {
