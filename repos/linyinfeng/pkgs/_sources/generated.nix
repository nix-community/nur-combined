...
}:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.12.8";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.12.8/app-x86_64.asar";
      sha256 = "sha256-Rh6IDGPdaAsuNLEE7mTrLmY2fQlaEH3QUCVNiO4+QDg=";
    };
  };
  linux-intel-lts = {
  ...
  linux-intel-mainline-tracking = {
    ...
    version = "mainline-tracking-v6.9-linux-240626T065432Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "mainline-tracking";
      rev = "mainline-tracking-v6.9-linux-240626T065432Z";
      fetchSubmodules = false;
      sha256 = "sha256-hKypDimiuNxXQAsgjABGyDXbmDyEAXChTU55m3/DaMM=";
    };
  };
  lpac = {
    pname = "lpac";
  ...
  waybar-git = {
    pname = "waybar-git";
    version = "ca3877d0b8e8e6cb484c6a9c6d5dcaff5fab0b74";
    src = fetchgit {
      url = "https://github.com/Alexays/Waybar.git";
      rev = "ca3877d0b8e8e6cb484c6a9c6d5dcaff5fab0b74";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-2gC2/k/zlsF88Bs15mjYY1MoBPm2z4h6ROpawXU99ps=";
    };
    date = "2024-07-02";
  };
  yacd = {
