...
}:
{
  ...
  codestable = {
    pname = "codestable";
    version = "8407d6dfba72e21ca7a0e38764b5883c382aeaa0";
    src = fetchgit {
      url = "https://github.com/liuzhengdongfortest/CodeStable";
      rev = "8407d6dfba72e21ca7a0e38764b5883c382aeaa0";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-JTCZW2Zc3DnWJux5tz3MDEvMO/g2QIhU4QPptFP74Xg=";
    };
    date = "2026-08-03";
  };
  cowrie = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.0.12";
      fetchSubmodules = false;
      sha256 = "sha256-xuXf9iapM7hJG1BVTsPeEOLPMezpKje5T85SOa+0R7Y=";
    };
  };
  dot-tar = {
    pname = "dot-tar";
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.18.38-linux-260722T115920Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.18.38-linux-260722T115920Z";
      fetchSubmodules = false;
      sha256 = "sha256-ockhrqThTGDqogH7lzd3Iro4WytUwEIGVb2WmVXq7g4=";
    };
  };
