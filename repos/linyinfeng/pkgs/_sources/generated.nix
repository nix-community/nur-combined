...
}:
{
  ...
  baibot = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.7.2";
      fetchSubmodules = false;
      sha256 = "sha256-+Q+9JszTg/j1f109GsupFyfE0a6EQofCVWQwFmjBRHU=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./baibot-v1.7.2/Cargo.lock;
      outputHashes = {
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.12.30-linux-250530T032816Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.12.30-linux-250530T032816Z";
      fetchSubmodules = false;
      sha256 = "sha256-+AeYVWtpgyU8S+3JNh+oPMTYEcKC1LzS+TDlz/pq3aE=";
    };
  };
