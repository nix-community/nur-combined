...
}:
{
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.12.36-linux-250711T071314Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.12.36-linux-250711T071314Z";
      fetchSubmodules = false;
      sha256 = "sha256-XYPYfF/XMFv0hd/tj0bxpGf6V6awq1GC5ZolrK9L9TQ=";
    };
  };
  ...
  rime-ice = {
    ...
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-bVbvRfrlkdkJe/q9fYqTM4LESwq/7jwrp40j1/LyFnM=";
    };
    date = "2025-07-21";
  };
  rime-loengfan = {
  ...
  rime-terra-pinyin = {
    ...
    version = "481326053106835a5d73d74b74863cea2ff409f9";
    src = fetchgit {
      url = "https://github.com/rime/rime-terra-pinyin.git";
      rev = "481326053106835a5d73d74b74863cea2ff409f9";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-zyhJZ/ALGPOfWH55PVm1z90LqclXjsAKNJ1eJb1548I=";
    };
    date = "2025-07-22";
  };
  rime-wubi = {
