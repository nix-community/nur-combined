...
{ fetchgit, fetchurl }:
{
  clash-for-windows = {
    ...
    version = "0.18.0";
    src = fetchurl {
      sha256 = "07gmi1mxy9plv5rc64nivi0xwvb2svawmvhli78bnh6kwid2kd2z";
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.18.0/Clash.for.Windows-0.18.0-x64-linux.tar.gz";
    };
