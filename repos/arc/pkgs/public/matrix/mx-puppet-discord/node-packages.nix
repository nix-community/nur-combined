...
let
  sources = {
    ...
    "@discordjs/node-pre-gyp-0.4.5" = {
      ...
      version = "0.4.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@discordjs/node-pre-gyp/-/node-pre-gyp-0.4.5.tgz";
        sha512 = "YJOVVZ545x24mHzANfYoy0BJX5PDyeZlpiJjDkUBM/V/Ao7TFX9lcUvCN4nr0tbr5ubeaXxtEBILUrHtTphVeQ==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@discordjs/node-pre-gyp-0.4.5"
