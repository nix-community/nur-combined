...
local function list_update(w, buttons, label, data, objects)
   ...
   for i, o in ipairs(objects) do
      ...
      if cache then
         ...
         cbm = wibox.container.margin(cb, dpi(2), dpi(2), dpi(2), dpi(2)) -- 4, 8 ,12 ,12 -- close button
         ...
         ibm = wibox.container.margin(ib, dpi(6), dpi(6), dpi(2), dpi(2)) -- 12 is default top and bottom margin --app icon
      ...
      if text == nil or text == '' then
         ...
         if (text_only:len() > 3) then
            text = text:gsub('>(.-)<', '>' .. text_only:sub(1, 3) .. '...<')
