...
# and putting NIX_PATH=nixpkgs-overlays=/path/to/this/file.nix on the nixbld environment
# or passing `-I nixpkgs-overlays=/path/to/this/file.nix` to any `nix` command.
#
