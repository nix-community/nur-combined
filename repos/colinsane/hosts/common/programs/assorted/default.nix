...
in
{
  sane.programs = {
    ...
    pcGuiApps = declPackageSet [
      ...
      "cups"
      "discord"  # x86-only
      "DTMFtool"  # qt5, probably doesn't cross-compile
      # "electrum"
      "element-desktop"
      "firefox"
      "font-manager"
    ...
    ccls.sandbox.method = null;  #< TODO: sandbox
    ...
    ctags-lsp.sandbox.method = null;  #< TODO: sandbox
    ...
    rustc.sandbox.method = null;  #< TODO: sandbox
    ...
    sourcekit-lsp.sandbox.method = null;  #< TODO: sandbox
