  ...
  sources = {
    ...
    "own-or-1.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "NfZr5+Tdf6MB8UI9GLvKRs4cXY8/yB0w3xtt84xFdWy8hkGjn+JFc60VhzS/hFRfbyxFcGYMTjnF4Me+RbbqrA==";
      };
    };
    "own-or-env-1.0.2" = {
      name = "own-or-env";
    ...
    "tap-15.1.6" = {
      ...
      src = fetchurl {
        ...
        sha512 = "TN7xH6Q2tUPTd6qwmkhuFJcx1vUR8e4dDUpBKc61G0krOzne7Ia6aKIFb8O/0kVazachSSuVME1V8nQ2xwWL8w==";
      };
    };
    ...
    "trivial-deferred-1.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "dagAKX7vaesNNAwOc9Np9C2mJ+7YopF4lk+jE2JML9ta4kZ91Y6UruJNH65bLRYoUROD8EY+Pmi44qQWwXR7sw==";
      };
    };
    ...
    "unicode-length-2.1.0" = {
      ...
      version = "2.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/unicode-length/-/unicode-length-2.1.0.tgz";
        sha512 = "4bV582zTV9Q02RXBxSUMiuN/KHo5w4aTojuKTNT96DIKps/SIawFp7cS5Mu25VuY1AioGXrmYyzKZUzh8OqoUw==";
      };
    };
