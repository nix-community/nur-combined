# This is a copy from nixpkgs/pkgs/google-chrome when the version is 138.0.7204.183
{
  fetchurl,
  lib,
  makeWrapper,
...
let
  ...
  linux = stdenvNoCC.mkDerivation (finalAttrs: {
    ...
    src = fetchurl {
      url = "https://mirror.cs.uchicago.edu/google-chrome/pool/main/g/google-chrome-stable/google-chrome-stable_${finalAttrs.version}-1_amd64.deb";
  ...
  # No update as we just want to pin the version
  ...
  meta = {
    ...
    description =''
      ...
      Google Chrome 138 is the last version support enabling Mainfest v2 without extra flags
    '';
