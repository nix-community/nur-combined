...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-PRPTIky/UV9l9FPqvAyNMtqnV0TG6sPznIOZeGaBAKE=";
  };

  workspace = buildNpmPackage (subFinalAttrs: {
    ...
    npmDepsHash = "sha256-oEx9Ztb4GHo4StolVRHOrKwgN2IkqBy67LojLJGDTwk=";
  });
  ...
  frontend = buildNpmPackage (subFinalAttrs: {
    ...
    npmDepsHash = "sha256-pfU2HzDBuqgT7+W+wmkzP9iL1hjcAHf/r6x7aCpDsrw=";
  ...
  daemon = buildNpmPackage (subFinalAttrs: {
    ...
    patches = [
      ...
      (replaceVars ./Replace-hardcoded-PTY-and-zip-tools-paths-with-place.patch {
        ptyPath = lib.getExe mcsmanager-pty;
        zipToolsPath = lib.getExe mcsmanager-zip-tools;
        "7zPath" = lib.getExe _7zz;
      })
    ...
    npmDepsHash = "sha256-DhjvBDwtQb8l8Kslko2GFbwa5YdtWINfoxfPzhQVWzg=";
  ...
  panel = buildNpmPackage (subFinalAttrs: {
    ...
    patches = [
      ...
      (replaceVars ./Replace-static-path-with-placeholder-in-panel.patch {
        frontendDist = finalAttrs.frontend;
      })
    ];
    ...
    postPatch = ''
      ...
      cp -r ${finalAttrs.common}/lib/node_modules/mcsmanager-common ../common
      cp -r ${finalAttrs.workspace}/lib/node_modules/mcsmanager-workspace/node_modules ../
    ...
    npmDepsHash = "sha256-9yuGGTrDGdwhp455J5c0a1+F2UMJndINZqNgKws5kIQ=";
  ...
  passthru.updateScript = nix-update-script {
    # The order of workspace, frontend, common, daemon, and panel must be preserved here.
    extraArgs = [
      "-s"
      "workspace"
      "-s"
