...
}:
{
  ...
  geolite2-asn = {
    ...
    version = "2026.01.19";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.01.19/GeoLite2-ASN.mmdb";
      sha256 = "sha256-OVFyJ56s+G+DlBiVARMry1lP1qfiJtCk7L6XixzsHmw=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    version = "2026.01.19";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.01.19/GeoLite2-City.mmdb";
      sha256 = "sha256-7v484UnOmL5eKLFLsFV6sw+sqXcgs2uCAhjA5ALRPmo=";
    };
  };
  geolite2-country = {
    ...
    version = "2026.01.19";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.01.19/GeoLite2-Country.mmdb";
      sha256 = "sha256-bD+ZOVGEEKUBP8T4b4mSXs8MAQwumS0n5oKuUB3Gp0k=";
    };
  };
  git-mcp-server = {
  ...
  mautrix-telegramgo = {
    ...
    version = "8f3cc2e28e903ba9229f5ea80774e380d26bf5fe";
    src = fetchFromGitHub {
      owner = "mautrix";
      repo = "telegramgo";
      rev = "8f3cc2e28e903ba9229f5ea80774e380d26bf5fe";
      fetchSubmodules = false;
      sha256 = "sha256-FqrSo9vaHL2kwukA4+dcqwb9HMn3e3EviLyQhkQIYYs=";
    };
    date = "2026-01-19";
  };
  mm-geofeed-verifier = {
  ...
  opencode = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.1.26";
      fetchSubmodules = false;
      sha256 = "sha256-3PpnLiVB+MxnWmdKolUpQ9BQf7nzzRQhoTsL8m0eIBA=";
    };
  };
  pixy2 = {
    pname = "pixy2";
  ...
  v2ray-rules-dat-geoip = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202601192216/geoip.dat";
  ...
  v2ray-rules-dat-geosite = {
    ...
    version = "202601192216";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202601192216/geosite.dat";
