...
}:
{
  ...
  mautrix-telegramgo = {
    ...
    version = "f4830c71d834b2ea52778aef94c30269e75a3549";
    src = fetchFromGitHub {
      owner = "mautrix";
      repo = "telegramgo";
      rev = "f4830c71d834b2ea52778aef94c30269e75a3549";
      fetchSubmodules = false;
      sha256 = "sha256-Q9zYAeUpY+vEsVbMBAGxxSyTluBpEb4TCFG0hn2+tG0=";
    };
    date = "2026-01-12";
  };
  mm-geofeed-verifier = {
  ...
  opencode = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.1.23";
      fetchSubmodules = false;
      sha256 = "sha256-cvz4HO5vNwA3zWx7zdVfs59Z7vD/00+MMCDbLU5WKpM=";
    };
  };
  pixy2 = {
    pname = "pixy2";
  ...
  v2ray-rules-dat-geoip = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202601152216/geoip.dat";
  ...
  v2ray-rules-dat-geosite = {
    ...
    version = "202601152216";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202601152216/geosite.dat";
