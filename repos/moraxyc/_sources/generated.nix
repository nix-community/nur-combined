...
}:
{
  ...
  geolite2-asn = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-+tbzDYWFoYqKIu2kFBysp7qSGvDEYcoAvE/NOVQRU6s=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-SZ/m8b53sawF86Ak46uX7CxdzEMFrmob7Yd12Y+xJfA=";
    };
  };
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-0wMeAhllI8u190KREiAz8r4neyEwq+3Utb7lK6eYMr4=";
    };
  };
  git-mcp-server = {
  ...
  mpv-danmaku = {
    pname = "mpv-danmaku";
    version = "f61476316b686e232c82290726fb9488d05560a5";
    src = fetchFromGitHub {
      owner = "moraxyc";
      repo = "mpv-danmaku";
      rev = "f61476316b686e232c82290726fb9488d05560a5";
      fetchSubmodules = false;
      sha256 = "sha256-vYqkzqNofY/CIa04ftcbiSGC7KyvsSV0X/NIIE0nWYw=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-vYqkzqNofY_CIa04ftcbiSGC7KyvsSV0X_NIIE0nWYw=/Cargo.lock";
      outputHashes = {
  ...
  nipaplay-reload-darwin = {
    ...
    version = "1.9.15";
    src = fetchurl {
      url = "https://github.com/MCDFsteve/NipaPlay-Reload/releases/download/v1.9.15/NipaPlay_1.9.15_macOS_Universal.dmg";
      sha256 = "sha256-VbtWEQZ215UQBRAnEjM2y3mSpK9tUfP74rXmfy88wJI=";
    };
  };
  nipaplay-reload-x86_64-linux = {
    ...
    version = "1.9.15";
    src = fetchurl {
      url = "https://github.com/MCDFsteve/NipaPlay-Reload/releases/download/v1.9.15/NipaPlay-1.9.15-Linux-amd64.AppImage";
      sha256 = "sha256-lR0R8TULrtgqSA60gapAtnfu7QNPGHNU9CNbmubpWQ4=";
    };
  };
  niri = {
    pname = "niri";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-I0kDpLy/mtWj9wkUszQm+VUM6bBAaqXfaHh9fn812qg=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-I0kDpLy_mtWj9wkUszQm+VUM6bBAaqXfaHh9fn812qg=/Cargo.lock";
      outputHashes = {
  ...
  v2ray-rules-dat-geoip = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202603022221/geoip.dat";
  ...
  v2ray-rules-dat-geosite = {
    ...
    version = "202603022221";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202603022221/geosite.dat";
