...
}:
{
  ...
  clash-nyanpasu = {
    ...
    version = "aa88e63326ef449d6d8ccbc6f556976eabafd58d";
    src = fetchFromGitHub {
      owner = "libnyanpasu";
      repo = "clash-nyanpasu";
      rev = "aa88e63326ef449d6d8ccbc6f556976eabafd58d";
      fetchSubmodules = false;
      sha256 = "sha256-O/4GcJ8vS5MhZBGIWZMtQspN44ERuFNXegc3BAfWVcI=";
    };
    cargoLock."backend/Cargo.lock" = {
      lockFile = ./. + "/sha256-O_4GcJ8vS5MhZBGIWZMtQspN44ERuFNXegc3BAfWVcI=/backend/Cargo.lock";
      outputHashes = {
  ...
  cpa-usage-keeper = {
    ...
    version = "8675c977db2523a64e19ab4fdb52b6a0aedf35a6";
    src = fetchFromGitHub {
      owner = "Willxup";
      repo = "cpa-usage-keeper";
      rev = "8675c977db2523a64e19ab4fdb52b6a0aedf35a6";
      fetchSubmodules = false;
      sha256 = "sha256-LChdcBzBFehB8QUdsj4KSDYym7YcPYOiMm+KB0GhTrY=";
    };
    extract = {
      "web/package.json" = ./. + "/sha256-LChdcBzBFehB8QUdsj4KSDYym7YcPYOiMm+KB0GhTrY=/web/package.json";
      "web/package-lock.json" = ./. + "/sha256-LChdcBzBFehB8QUdsj4KSDYym7YcPYOiMm+KB0GhTrY=/web/package-lock.json";
    };date = "2026-06-08";
  };
  ...
  geolite2-asn = {
    ...
    version = "2026.06.07";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.06.07/GeoLite2-ASN.mmdb";
      sha256 = "sha256-0jbVMggUBys7AA10aHBN46nUuIFwc0HaCbYjyE+VTfc=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    version = "2026.06.07";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.06.07/GeoLite2-City.mmdb";
      sha256 = "sha256-+8wIK6QE0cmXYOYNPvr3IFrgWfsQ27Pr+Hf0aYMvx78=";
    };
  };
  geolite2-country = {
    ...
    version = "2026.06.07";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.06.07/GeoLite2-Country.mmdb";
      sha256 = "sha256-KRyLNRdxtX1wPJt30mV5DI/15igd5vb12owkmqq/k7g=";
    };
  };
  git-mcp-server = {
  ...
  loyalsoldier-geoip = {
    ...
    version = "98c33e8950aff3012be7054424755d709fac8322";
    src = fetchFromGitHub {
      owner = "Loyalsoldier";
      repo = "geoip";
      rev = "98c33e8950aff3012be7054424755d709fac8322";
      fetchSubmodules = false;
      sha256 = "sha256-ebu9q1ssXd0qd5WRQtsvNZD+Nt9hWXN0lOLHpYyXQFg=";
    };
    date = "2026-06-07";
  };
  manpage-zh = {
  ...
  meta-rules-dat = {
    ...
    version = "90f26dc13d3f319bd6431d4bb23eb4b97d512995";
    src = fetchFromGitHub {
      owner = "MetaCubeX";
      repo = "meta-rules-dat";
      rev = "90f26dc13d3f319bd6431d4bb23eb4b97d512995";
      fetchSubmodules = false;
      sha256 = "sha256-zx0UBLRWE2vqfW7TSBIbbhPD53MKBGM24XGS/b5Lcpo=";
    };
    date = "2026-06-08";
  };
  metacubex-geo = {
  ...
  v2ray-rules-dat = {
    ...
    version = "949d247fb28f5b41a246499d7dda73a6c7c03269";
    src = fetchFromGitHub {
      owner = "Loyalsoldier";
      repo = "v2ray-rules-dat";
      rev = "949d247fb28f5b41a246499d7dda73a6c7c03269";
      fetchSubmodules = false;
      sha256 = "sha256-1IswFrs8fIBo45GHTdhDOlivd1EIBsVFWdhxZlAz+fA=";
    };
    date = "2026-06-08";
  };
}
