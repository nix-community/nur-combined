...
}:
{
  ...
  clash-nyanpasu = {
    ...
    version = "70e863d2895c4f418a7e52fa1067530a8f93c3ab";
    src = fetchFromGitHub {
      owner = "libnyanpasu";
      repo = "clash-nyanpasu";
      rev = "70e863d2895c4f418a7e52fa1067530a8f93c3ab";
      fetchSubmodules = false;
      sha256 = "sha256-bJCyECet1JbUZq6yV0uk1LNUA5GhkTYDLISyJ5CNkXE=";
    };
    cargoLock."backend/Cargo.lock" = {
      lockFile = ./. + "/sha256-bJCyECet1JbUZq6yV0uk1LNUA5GhkTYDLISyJ5CNkXE=/backend/Cargo.lock";
      outputHashes = {
  ...
  cpa-usage-keeper = {
    ...
    version = "ee143ebd3e7551bf4bdab955a5a32154509f2117";
    src = fetchFromGitHub {
      owner = "Willxup";
      repo = "cpa-usage-keeper";
      rev = "ee143ebd3e7551bf4bdab955a5a32154509f2117";
      fetchSubmodules = false;
      sha256 = "sha256-e/vT5lEjid9c1BIGZ7lBX3zZkqu77JovYay9Vuyq9OU=";
    };
    extract = {
      "web/package.json" = ./. + "/sha256-e_vT5lEjid9c1BIGZ7lBX3zZkqu77JovYay9Vuyq9OU=/web/package.json";
      "web/package-lock.json" = ./. + "/sha256-e_vT5lEjid9c1BIGZ7lBX3zZkqu77JovYay9Vuyq9OU=/web/package-lock.json";
    };date = "2026-06-23";
  };
  ...
  geolite2-asn = {
    ...
    version = "2026.06.22";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.06.22/GeoLite2-ASN.mmdb";
      sha256 = "sha256-VJ0d6QcJmJVHumP8Cq/Is57FqnWYJgjKTOKg/KNAAbg=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    version = "2026.06.22";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.06.22/GeoLite2-City.mmdb";
      sha256 = "sha256-k5TK1Q63q5IE3RjWStZ2qTcchtHf00bZ2Pidvj6+9Yw=";
    };
  };
  geolite2-country = {
    ...
    version = "2026.06.22";
    src = fetchurl {
      url = "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2026.06.22/GeoLite2-Country.mmdb";
      sha256 = "sha256-zIce5Iuz6F6bzpkdUk14ISlZ3P4TLEKskDl78Qnbgcs=";
    };
  };
  git-mcp-server = {
  ...
  loyalsoldier-geoip = {
    ...
    version = "ec4ee157d293c9976253780d0bcb5bef4ccbe1b0";
    src = fetchFromGitHub {
      owner = "Loyalsoldier";
      repo = "geoip";
      rev = "ec4ee157d293c9976253780d0bcb5bef4ccbe1b0";
      fetchSubmodules = false;
      sha256 = "sha256-TqPh2X382xdWc/673MzM9WKtXZnrUijBoiuzfdJIDps=";
    };
    date = "2026-06-18";
  };
  manpage-zh = {
  ...
  meta-rules-dat = {
    ...
    version = "827eae73ba9ffba427b0b838961516708a036db6";
    src = fetchFromGitHub {
      owner = "MetaCubeX";
      repo = "meta-rules-dat";
      rev = "827eae73ba9ffba427b0b838961516708a036db6";
      fetchSubmodules = false;
      sha256 = "sha256-xprFBaCsyYxyRhALZd9CUOuAOm/O/RLqxmWGyEdZocI=";
    };
    date = "2026-06-22";
  };
  metacubex-geo = {
  ...
  nezha = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.2.6";
      fetchSubmodules = false;
      sha256 = "sha256-HsDymQ1y4ouUMpcpSycSfbwJm+hzct7U0Wjm/ouorO0=";
    };
  };
  nezha-agent = {
    pname = "nezha-agent";
  ...
  nyanpasu-service = {
    ...
    version = "b62f3c2ea3e67fd2666a09c8637f383323a647a7";
    src = fetchFromGitHub {
      owner = "libnyanpasu";
      repo = "nyanpasu-service";
      rev = "b62f3c2ea3e67fd2666a09c8637f383323a647a7";
      fetchSubmodules = false;
      sha256 = "sha256-Tq73bF5fdotE4jURcibAn8JvMzlwKgsrpch7JtHS5fE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-Tq73bF5fdotE4jURcibAn8JvMzlwKgsrpch7JtHS5fE=/Cargo.lock";
      outputHashes = {
  ...
  opencode-telegram-bot = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.21.2";
      fetchSubmodules = false;
      sha256 = "sha256-NEaQ2grHCKXi13utcHeUR83pJT6kqBGS4UqllhG93kY=";
    };
    extract = {
  ...
  uuremote = {
    ...
    version = "4.29.0";
    src = fetchurl {
      url = "https://a56.gdl.netease.com/uuyc_4.29.0.pkg";
      sha256 = "sha256-onk33I8AfG7TurNEZpB7RbJfFOm/rB87vxH4dXo/Vs0=";
    };
  };
  v2ray-rules-dat = {
    pname = "v2ray-rules-dat";
    version = "54022e3d5823fc99e3209c379e42c9224d997e49";
    src = fetchFromGitHub {
      owner = "Loyalsoldier";
      repo = "v2ray-rules-dat";
      rev = "54022e3d5823fc99e3209c379e42c9224d997e49";
      fetchSubmodules = false;
      sha256 = "sha256-vnRGxKGM0fHYUb4axyp2ARYcXTRJUXzez21zS9coYXI=";
    };
    date = "2026-06-22";
  };
  whois42d-ng = {
