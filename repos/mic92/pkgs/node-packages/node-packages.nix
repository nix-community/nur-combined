...
in
{
  ...
  reveal-md = nodeEnv.buildNodePackage {
    ...
    version = "5.0.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/reveal-md/-/reveal-md-5.0.0.tgz";
      sha512 = "EQIXqFHuOg82aY9dNrehec20b3bHFoseVrNUaeU7CDuysEyWiw1Tagg7T83lIIu6QENETGawQYMFTAloBz+Dxw==";
    };
    dependencies = [
