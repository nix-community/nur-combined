...
in
{
  ...
  reveal-md = nodeEnv.buildNodePackage {
    ...
    version = "5.1.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/reveal-md/-/reveal-md-5.1.2.tgz";
      sha512 = "gwRslYVi8hSLbrtgbFQGaeqljhlOelLWtmXVSIQcZjPDBNCdSlGuCGkfVjgYXs0/nxuU0xmuGynLfXn7jdTq8w==";
    };
    dependencies = [
