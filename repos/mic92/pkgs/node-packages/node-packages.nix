...
in
{
  speedscope = nodeEnv.buildNodePackage {
    ...
    version = "1.15.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/speedscope/-/speedscope-1.15.0.tgz";
      sha512 = "MHvlCBGi0arU8LG+rsz052r5Kph9xLfKiAL4psyp8Cp1rh9hpyey/bRHYR2wreQQqMpM/zeDlfXfHUSBwIpxCA==";
    };
    dependencies = [
