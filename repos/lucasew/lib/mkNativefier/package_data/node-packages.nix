...
let
  sources = {
    ...
    "@types/cheerio-0.22.22" = {
      ...
      version = "0.22.22";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/cheerio/-/cheerio-0.22.22.tgz";
...
in
{
  nativefier = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "o/V4MAtjIIb5g/pnvKZ5bH/pKc/8gBxSO5jK55TWjHTbORDQsX/RYc5poQE6H+Pgo5k9R0+iqnRpl35Q9Bu6aA==";
    };
    dependencies = [
