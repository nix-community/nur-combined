...
desktop: wallpaper: {
	dir:     "\(runtime.dotfiles_root)/assets/wallpapers"
	default: "wall.jpg"
}
...
modules: {
	icons: {
		...
		enable: runtime.hostname == "whiterun" || runtime.hostname == "riverwood"
		config: {
...
backup: {
	actions: [
		...
		if (#is_whiterun || #is_riverwood) {
			...
			src:  "\(runtime.home)/WORKSPACE/CANTGIT/"
		...
		// 	output: "\(runtime.home)/.cache/backup/termux/packages.txt"
		// },
		...
		// 	kind: "rsync"
		// 	skip_permissions: true
		// 	src:  "\(runtime.home)/.cache/backup/termux/"
		// 	dst:  "\(#rsyncnet_user):\(#remote_path)/termux/"
		// },
		// if #is_phone {
		// 	name:      "termux archive"
		// 	kind:      "archive"
		// 	input_dir: "\(runtime.home)/.cache/backup/termux"
		// 	output:    "\(runtime.home)/.cache/backup/termux.tar"
		// 	format:    "tar"
		// },
		// if #is_phone {
		...
		// 	kind: "rsync"
		// 	skip_permissions: true
		// 	src:  "\(runtime.home)/.cache/backup/termux.tar"
