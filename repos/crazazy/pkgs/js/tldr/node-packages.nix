...
let
  sources = {
    ...
    "natural-2.3.0" = {
      ...
      version = "2.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/natural/-/natural-2.3.0.tgz";
        sha512 = "Mi4t8C/1v85Jk3akQbj2dCQ1SKNvLcF8+QxBe1/Bnb9R223VwLSXpkXaZxo7U4e2PaHbNTGv9xhgHNjtcBIp3A==";
      };
    };
    "node-unzip-2-0.2.8" = {
      name = "node-unzip-2";
