...
let
  sources = {
    ...
    "es-module-lexer-1.4.0" = {
      ...
      version = "1.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/es-module-lexer/-/es-module-lexer-1.4.0.tgz";
        sha512 = "lcCr3v3OLezdfFyx9r5NRYHOUTQNnFEQ9E87Mx8Kc+iqyJNkO7MJoB4GQRTlIMw9kLLTwGw0OAkm4BQQud/d9g==";
      };
    };
    "escalade-3.1.1" = {
      name = "escalade";
