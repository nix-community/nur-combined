...
let
  sources = {
    ...
    "@jspm/core-1.0.4" = {
      ...
      version = "1.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@jspm/core/-/core-1.0.4.tgz";
        sha512 = "HoA6n4sjAEzU3BnGQpaTPXN0tFbzTe6sGHeuF4Yr9ULsheCwnHrBFOawqK4JDWxCEZQRyuqJv0tgNHTP5eLDMw==";
      };
    };
    "@jspm/github-1.0.4" = {
    ...
    "@types/node-13.1.1" = {
      ...
      version = "13.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-13.1.1.tgz";
        sha512 = "hx6zWtudh3Arsbl3cXay+JnkvVgCKzCWKv42C9J01N2T2np4h8w5X8u6Tpz5mj38kE3M9FM0Pazx8vKFFMnjLQ==";
      };
    };
    "abbrev-1.1.1" = {
      name = "abbrev";
    ...
    "spdx-license-list-6.1.0" = {
      ...
      version = "6.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/spdx-license-list/-/spdx-license-list-6.1.0.tgz";
        sha512 = "xiaE3KtBiylVmZrlux8tHR28HZgZ921HTXbx2fEZaDloRjbBOro79LeKttcQJ5MSDYFKG7in9v2GTAEhcR9/Qg==";
      };
    };
    "split-string-3.1.0" = {
      name = "split-string";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."spdx-license-list-6.1.0"
