...
let
  sources = {
    ...
    "caniuse-db-1.0.30001016" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-db/-/caniuse-db-1.0.30001016.tgz";
        sha512 = "4G/7ef/NFSAsn9nFIiPvQr+ayoeLJP3wnQH23BPBJKofNdxFild5dokOjUj4tLFA5yd/VHllhzX55IPLwXhRtg==";
      };
    };
    ...
    "cross-spawn-promise-0.10.1" = {
      ...
      version = "0.10.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/cross-spawn-promise/-/cross-spawn-promise-0.10.1.tgz";
        sha1 = "db9cb4c50c60b72a15be049b78122ce382d87b10";
      };
    };
    ...
    "ejs-loader-0.3.5" = {
      ...
      version = "0.3.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/ejs-loader/-/ejs-loader-0.3.5.tgz";
        sha512 = "96Zt17hrKINvbdYUxk5TC5a18J9lIdKLPKIngl9dSyZBsNDKAFibY3z/VBcyq0jWGQkIemLsjdIJIAu4T0CB8A==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."caniuse-db-1.0.30001016"
      ...
      sources."cross-spawn-promise-0.10.1"
