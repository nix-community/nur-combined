...
let
  sources = {
    ...
    "rollup-2.53.0" = {
      ...
      version = "2.53.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/rollup/-/rollup-2.53.0.tgz";
        sha512 = "spgrY78Toh+m0+zaOoeaayJKuzFuWy6o1PdFIBMVwRcuxT0xCOX9A5rChyKe+2ruL4lePKWUMImS4mMW1QAkmQ==";
      };
    };
