...
let
  sources = {
    ...
    "nanoid-3.1.32" = {
      ...
      version = "3.1.32";
      src = fetchurl {
        url = "https://registry.npmjs.org/nanoid/-/nanoid-3.1.32.tgz";
    ...
    "rollup-2.64.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "+c+lbw1lexBKSMb1yxGDVfJ+vchJH3qLbmavR+awDinTDA2C5Ug9u7lkOzj62SCu0PKUExsW36tpgW7Fmpn3yQ==";
      };
    };
