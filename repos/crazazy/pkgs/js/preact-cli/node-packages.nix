...
let
  sources = {
    ...
    "@babel/preset-env-7.14.8" = {
      ...
      version = "7.14.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/@babel/preset-env/-/preset-env-7.14.8.tgz";
    ...
    "colord-2.4.0" = {
      ...
      version = "2.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/colord/-/colord-2.4.0.tgz";
        sha512 = "2306/NeTDOykDwvFQK0ctnP+9I5KQdqVm+IJAM6MsAr4vvy1llAdJyax4YmZoqTxdJ/lvRBwR8MqyJi/tupBAw==";
      };
    };
    "colorette-1.2.2" = {
      name = "colorette";
    ...
    "es-abstract-1.18.4" = {
      ...
      version = "1.18.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/es-abstract/-/es-abstract-1.18.4.tgz";
        sha512 = "xjDAPJRxKc1uoTkdW8MEk7Fq/2bzz3YoCADYniDV7+KITCUdu9c90fj1aKI7nEZFZxRrHlDo3wtma/C6QkhlXQ==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@babel/preset-env-7.14.8"
