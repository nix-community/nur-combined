...
let
  sources = {
    ...
    "core-js-compat-3.22.0" = {
      ...
      version = "3.22.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/core-js-compat/-/core-js-compat-3.22.0.tgz";
        sha512 = "WwA7xbfRGrk8BGaaHlakauVXrlYmAIkk8PNGb1FDQS+Rbrewc3pgFfwJFRw6psmJVAll7Px9UHRYE16oRQnwAQ==";
      };
    };
    "core-util-is-1.0.2" = {
      name = "core-util-is";
