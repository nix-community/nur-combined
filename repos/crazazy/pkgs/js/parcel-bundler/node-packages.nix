...
let
  sources = {
    ...
    "posthtml-0.13.2" = {
      ...
      version = "0.13.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/posthtml/-/posthtml-0.13.2.tgz";
        sha512 = "WVXgLnzwget6xI+yOV/eujHKC7+057+smtImFkd4l/szxWZ4wmU0wF+JH+RX6x1+iqB0F8019XKOzETPJ/iGHg==";
      };
    };
