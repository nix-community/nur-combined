{ pkgs }: {
  ...
  in {
    ...
    semble = pkgs.callPackage ./pkgs/minishLab/semble { inherit model2vec vicinity bm25s tree-sitter-language-pack; };
    inherit model2vec vicinity bm25s tree-sitter-language-pack;
  };
}
