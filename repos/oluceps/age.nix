{ config, data, lib, user, ... }:
{
  ...
  age = {
    ...
    secrets =
      ...
      (genMaterial [ "minisign.key" "ssh-cfg" "gh-eu" "riro.u2f" "elen.u2f" "gh-token" "age" "pub" "id" "id_sk" "minio" "prism" "aws-s3-cred" "vault" "restic-repo" "restic-repo-crit" "restic-envs" "restic-envs-crit" "attic" ]) //
