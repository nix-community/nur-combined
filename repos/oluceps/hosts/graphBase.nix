  ...
  environment.systemPackages = with inputs'.browser-previews.packages; [
    ...
    (pkgs.runCommand "chrome-entry" { } ''
      ...
      echo "[Desktop Entry]
            ...
            Comment[zh_CN]=访问互联网
            Exec=${lib.getExe google-chrome-beta} \
            ...
            --use-angle=vulkan \
            --enable-zero-copy \
            --enable-features=CanvasOopRasterization,Vulkan,VulkanFromANGLE,DefaultANGLEVulkan,VaapiVideoEncoder,ScrollableTabStrip,OverlayScrollbar \
            %U
            StartupNotify=true
            Terminal=false
            Icon=google-chrome
