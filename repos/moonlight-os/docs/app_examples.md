...
##### Windows
Helios has built-in support for changing the resolution and refresh rate on Windows. If you prefer to use a
...
> host, the Flatpak of Helios requires commands to be prefixed with `flatpak-spawn --host`.

#### Windows
**Elevating Commands (Windows)**

If you've installed Helios as a service (default), you can specify if a command should be elevated with
...
| Previous                          |                                    Next |
|:----------------------------------|----------------------------------------:|
| [Configuration](configuration.md) | [Awesome-Helios](awesome_helios.md) |
