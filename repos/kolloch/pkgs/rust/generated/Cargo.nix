    ...
    crates = {
      ...
      "cargo_metadata" = rec {
        ...
        dependencies = [
          ...
          {
            name = "serde_derive";
            packageId = "serde_derive 1.0.106";
          }
          {
            name = "serde_json";
            packageId = "serde_json 1.0.51";
          }
        ];
        features = {
        };
      ...
      "crate2nix" = rec {
        ...
        src = (pkgs.callPackage ../crate2nix.nix {}).source;
        authors = [
      ...
      "nix-test-runner" = rec {
        ...
        src = (pkgs.callPackage ../nix-test-runner.nix {}).source;
        authors = [
