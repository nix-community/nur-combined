...
in appimageTools.wrapAppImage {
  ...
  src = lib.warn
    "${name} from pokon548's NUR is deprecated and will be removed from NUR repo soon. Migrate by changing nur.repos.pokon548.tencent-qq-electron-bwrap to pkgs.qq"
    appimageContents;
  ...
  meta = with lib; {
    ...
    description =
      "Official Tencent QQ client for Linux (Beta) with enhanced bwrap rules";
