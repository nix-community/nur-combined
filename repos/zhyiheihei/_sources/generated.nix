...
}:
{
  ...
  epd-food-server = {
    ...
    version = "f1e81bf594248ebde0f77926f2a74a431bb4b0a8";
    src = fetchgit {
      url = "https://github.com/zhyiheihei/EPD-Dashboard.git";
      rev = "f1e81bf594248ebde0f77926f2a74a431bb4b0a8";
      fetchSubmodules = false;
      hash = "sha256-WZopQnFZbqVhvbVzhrWjs0oXz5EGDVRTxEEJSBM36Ns=";
    };
    date = "2026-09-13";
  };
  filecodebox = {
  ...
  nexus-media = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "nexus-media";
      tag = "v4.20.16";
      hash = "sha256-3KJpe3j+0rg3Uo21SkXr1aIpJwrJ0RvNF0OIDbzW224=";
    };
  };
  nexus-media-web = {
    ...
    src = fetchFromGitHub {
      ...
      tag = "v4.20.16";
      hash = "sha256-HDf0qNQW8ryv7XHliu1mbbnRsk6Q+KsNxJ3cVqZDlfs=";
    };
  };
  pinyin2hanzi = {
    pname = "pinyin2hanzi";
