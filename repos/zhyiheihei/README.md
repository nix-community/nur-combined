...
| - [ ] |  | `navdash` | [navdash](https://github.com/zhyiheihei/navdash) | 0.7.0 | Personal service portal with native OIDC login and Nix-generated service cards |
| - [x] |  | `nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.8.2 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.8.2 | Vue 3 web frontend for the Nexus Media media library manager |
...
| - [ ] |  | `uncategorized.navdash` | [navdash](https://github.com/zhyiheihei/navdash) | 0.7.0 | Personal service portal with native OIDC login and Nix-generated service cards |
| - [ ] |  | `uncategorized.nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.8.2 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `uncategorized.nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.8.2 | Vue 3 web frontend for the Nexus Media media library manager |
