...
| - [x] |  | `nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.20.8 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.20.8 | Vue 3 web frontend for the Nexus Media media library manager |
...
| - [x] |  | `vaults3` | [vaults3](https://github.com/Kodiqa-Solutions/VaultS3) | 4.4.74 | Lightweight S3-compatible object storage with built-in web dashboard |
...
| - [ ] |  | `uncategorized.nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.20.8 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `uncategorized.nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.20.8 | Vue 3 web frontend for the Nexus Media media library manager |
...
| - [ ] |  | `uncategorized.vaults3` | [vaults3](https://github.com/Kodiqa-Solutions/VaultS3) | 4.4.74 | Lightweight S3-compatible object storage with built-in web dashboard |
