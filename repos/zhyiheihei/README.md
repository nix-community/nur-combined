...
<details>
<summary>Package set: (Uncategorized) (26 packages)</summary>
...
| - [x] |  | `nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.16.1 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.16.1 | Vue 3 web frontend for the Nexus Media media library manager |
...
| - [x] |  | `vaults3` | [vaults3](https://github.com/Kodiqa-Solutions/VaultS3) | 4.4.70 | Lightweight S3-compatible object storage with built-in web dashboard |
...
<details>
<summary>Package set: uncategorized (15 packages)</summary>
...
| - [ ] |  | `uncategorized.nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.16.1 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `uncategorized.nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.16.1 | Vue 3 web frontend for the Nexus Media media library manager |
...
| - [ ] |  | `uncategorized.vaults3` | [vaults3](https://github.com/Kodiqa-Solutions/VaultS3) | 4.4.70 | Lightweight S3-compatible object storage with built-in web dashboard |
