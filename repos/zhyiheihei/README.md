...
<details>
<summary>Package set: (Uncategorized) (27 packages)</summary>
...
| - [x] |  | `filecodebox` | [filecodebox](https://github.com/vastsa/FileCodeBox) | 2.6.1 | Lightweight anonymous file sharing server with a FastAPI backend and Vue 3 theme |
...
| - [x] |  | `nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.20.18 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.20.18 | Vue 3 web frontend for the Nexus Media media library manager |
...
<details>
<summary>Package set: uncategorized (16 packages)</summary>
...
| - [ ] |  | `uncategorized.filecodebox` | [filecodebox](https://github.com/vastsa/FileCodeBox) | 2.6.1 | Lightweight anonymous file sharing server with a FastAPI backend and Vue 3 theme |
...
| - [ ] |  | `uncategorized.nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.20.18 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `uncategorized.nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.20.18 | Vue 3 web frontend for the Nexus Media media library manager |
