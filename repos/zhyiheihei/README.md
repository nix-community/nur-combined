...
| - [x] |  | `docker-proxy` | [docker-proxy](https://github.com/dqzboy/Docker-Proxy) | 5.1.6 | Self-hosted Docker registry proxy with host-based upstream routing |
| - [x] |  | `docker-proxy-hubcmdui` | [docker-proxy-hubcmdui](https://github.com/dqzboy/Docker-Proxy) | 5.1.6 | Web management panel for the Docker-Proxy registry proxy |
| - [x] |  | `filecodebox` | [filecodebox](https://github.com/vastsa/FileCodeBox) | 2.5.5 | Lightweight anonymous file sharing server with a FastAPI backend and Vue 3 theme |
...
| - [x] |  | `nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.11.10 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.11.10 | Vue 3 web frontend for the Nexus Media media library manager |
...
| State | Path | Name | Version | Description |
| ----- | ---- | ---- | ------- | ----------- |
| - [ ] |  | `uncategorized.docker-proxy` | [docker-proxy](https://github.com/dqzboy/Docker-Proxy) | 5.1.6 | Self-hosted Docker registry proxy with host-based upstream routing |
| - [ ] |  | `uncategorized.docker-proxy-hubcmdui` | [docker-proxy-hubcmdui](https://github.com/dqzboy/Docker-Proxy) | 5.1.6 | Web management panel for the Docker-Proxy registry proxy |
| - [ ] |  | `uncategorized.filecodebox` | [filecodebox](https://github.com/vastsa/FileCodeBox) | 2.5.5 | Lightweight anonymous file sharing server with a FastAPI backend and Vue 3 theme |
...
| - [ ] |  | `uncategorized.nexus-media` | [nexus-media](https://github.com/linyuan0213/nexus-media) | 4.11.10 | Media library manager with automated downloading, media organization and subscription workflows |
| - [ ] |  | `uncategorized.nexus-media-web` | [nexus-media-web](https://github.com/linyuan0213/nexus-media-web) | 4.11.10 | Vue 3 web frontend for the Nexus Media media library manager |
