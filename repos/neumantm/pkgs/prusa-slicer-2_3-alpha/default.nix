...
, cgal_5, gmp, ilmbase, mpfr, qhull, openvdb, systemd, dbus
}:
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    owner = "prusa3d";
    repo = "PrusaSlicer";
    sha256 = "1p9glfscdyxhr60rgy9pp0m313zxri5llv11q1v1dzk9zvhfhw6d";
  ...
  desktopItem = makeDesktopItem {
    name = "PrusaSlicer-2_3-alpha";
    exec = "prusa-slicer";
    icon = "PrusaSlicer";
    comment = "G-code generator for 3D printers";
    desktopName = "PrusaSlicer 2.3-alpha";
    genericName = "3D printer tool";
    categories = "Development;";
  };

  meta = with stdenv.lib; {
    description = "Alpha version of G-code generator for 3D printer";
