...
buildNpmPackage rec {
  ...
  # middleware: https://github.com/anyproto/anytype-ts/blob/v0.46.5/update-ci.sh
  # langs: https://github.com/anyproto/anytype-ts/blob/v0.46.5/electron/hook/locale.js
  postUnpack = ''
