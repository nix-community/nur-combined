...
buildNpmPackage rec {
  ...
  # middleware: https://github.com/anyproto/anytype-ts/blob/v0.47.5/update-ci.sh
  # langs: https://github.com/anyproto/anytype-ts/blob/v0.47.5/electron/hook/locale.js
  postUnpack = ''
