...
buildNpmPackage rec {
  ...
  # middleware: https://github.com/anyproto/anytype-ts/blob/v0.46.4/update-ci.sh
  # langs: https://github.com/anyproto/anytype-ts/blob/v0.46.4/electron/hook/locale.js
  postUnpack = ''
