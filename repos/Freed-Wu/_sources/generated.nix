...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  autotools-language-server = {
    ...
    version = "0.0.22";
    src = fetchurl {
      url = "https://pypi.org/packages/source/a/autotools_language_server/autotools_language_server-0.0.22.tar.gz";
      sha256 = "sha256-3qHc+2/GKiJTcc2OCQlTo2jRKyN2ADfWgU0NxIV1r98=";
    };
  };
  bash-prompt = {
    pname = "bash-prompt";
  ...
  pyrime = {
    ...
    version = "0.0.9";
    src = fetchurl {
      url = "https://pypi.org/packages/source/p/pyrime/pyrime-0.0.9.tar.gz";
      sha256 = "sha256-Top/VIuKoWn0HypYd7ihCS+WFwTsKZ6biZkUAWReb+E=";
    };
  };
