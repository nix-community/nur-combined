...
}:
{
  ...
  lsp-tree-sitter = {
    ...
    version = "0.2.6";
    src = fetchurl {
      url = "https://pypi.org/packages/source/l/lsp_tree_sitter/lsp_tree_sitter-0.2.6.tar.gz";
      sha256 = "sha256-fLG1MqxHXC3esuBczjkjsMqbuIWOwfUFIRoV6Zglq0Q=";
    };
  };
  manpager = {
    pname = "manpager";
  ...
  termux-language-server = {
    ...
    version = "0.1.1";
    src = fetchurl {
      url = "https://pypi.org/packages/source/t/termux_language_server/termux_language_server-0.1.1.tar.gz";
      sha256 = "sha256-oAtiK5QXu/3smFVFWDntonrBdZKTboeafeNZ+vIMu1Y=";
    };
  };
