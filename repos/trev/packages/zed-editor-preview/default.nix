...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-Yep/gmoYU7VHUI9oC22otMdbvnkVg3ehnDIJ3A4UtA8=";
  };
  ...
  cargoHash = "sha256-fwxGctGMsEQom/RiLVfPJK1BrbOsf46fli4rLuDuDhQ=";
  ...
  meta = {
    mainProgram = "zeditor";
    description = "High-performance, multiplayer code editor from the creators of Atom and Tree-sitter - preview version";
    license = lib.licenses.gpl3Only;
    platforms = lib.platforms.linux ++ lib.platforms.darwin;
    maintainers = with lib.maintainers; [ spotdemo4 ];
    homepage = "https://zed.dev";
    changelog = "https://github.com/zed-industries/zed/releases/tag/v${finalAttrs.version}-pre";
  };
})
