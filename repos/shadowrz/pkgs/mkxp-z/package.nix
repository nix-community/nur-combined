...
let
  ...
  rev = "826929eeb3ebc4b887c011604919217a790770f4";
in
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "sha256-qjKfwqwOXmVtIhPK4ODuSpmLyK+uROEAbc3vjSlY1pU=";
    inherit rev;
  };
  ...
  postPatch = ''
    ...
    sed -i "/git_hash = /s:git_hash = .*:git_hash = '${rev}':" meson.build
