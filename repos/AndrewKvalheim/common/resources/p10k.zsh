# Generated by Powerlevel10k configuration wizard on 2022-08-11 at 18:37 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%B%D{%H:%M:%S} ❯'
  ...
  function my_git_formatter() {
    ...
    local       meta='%B%0F' # black foreground
    local      clean='%B%0F' # black foreground
    local   modified='%B%0F' # black foreground
    local  untracked='%B%0F' # black foreground
    local conflicted='%B%0F' # black foreground
