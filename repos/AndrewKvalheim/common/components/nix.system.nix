...
in
{
  ...
  config = {
    ...
    # Cache
    nix.settings.trusted-public-keys = [ "nix-store.home.arpa:1IPrFEVB4K6/5Tokjv7lgvlxtxY2ZvL0t9Iy6ts5W4c=" ];
    nix.settings.substituters = [ "ssh://nix-ssh@nix-store.home.arpa?compress=true" ];
