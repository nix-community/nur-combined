  ...
  office-hours = (callPackage ./library/office-hours.pkg.nix {
    python3 = pkgs.python3.override {
      packageOverrides = _: pythonPackages: with pythonPackages; {
        icalendar =
          if (versionAtLeast icalendar.version "7") then icalendar else
          warn "Version override of icalendar is no longer necessary"
        ...
        sunrisesunset = if (pythonPackages ? sunrisesunset) then sunrisesunset else
        warn "Packaging of sunrisesunset is no longer necessary"
