{
  ...
  mkShinyFfUtil = description: derivargs: srcargs:
...
in {
  ...
  ff-overlay =
    ...
    {
      repo = "ff-overlay";
      hash = "sha256-E3vaZDj69X3tRqFxXMxZLaNwkhxsbtNodavab7ScLBo=";
    };
  ...
  ff-sort =
    ...
    {
      repo = "ff-sort";
      hash = "sha256-odUChDvivr+IyyvqpDQyrrxzIJe/Uge0K3ULx3SXdSk=";
    };
