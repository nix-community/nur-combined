...
rec {
  ...
  mkArduinoCoreInstall =
    pkgs.runCommandLocal "arduino-core"
      {
  ...
  mkArduinoCoreEspInstall =
    pkgs.runCommandLocal "arduino-core-esp"
      {
        nativeBuildInputs = [ pkgs.arduino-cli ];
      }
      ''
  ...
  mkArduinoDownloaded =
    pkgs.runCommandLocal "arduino-core-esp32-esp32"
      {
        core = "esp32:esp32";
        version = "2.0.14";
        nativeBuildInputs = [ pkgs.arduino-cli ];
