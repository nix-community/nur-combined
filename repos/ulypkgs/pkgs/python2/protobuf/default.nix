...
buildPythonPackage {
  ...
  patches =
    lib.optional (isPy37 && (lib.versionOlder protobuf.version "3.6.1.2"))
  ...
  setupPyGlobalFlags = lib.optional (lib.versionAtLeast protobuf.version "2.6.0") "--cpp_implementation";
