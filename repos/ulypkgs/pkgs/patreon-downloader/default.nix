...
buildDotnetModule (finalAttrs: {
  ...
  patches = [
    ...
    # https://github.com/AlexCSDev/PatreonDownloader/pull/285
    # https://github.com/AlexCSDev/UniversalDownloaderPlatform/pull/21
    ./auto-login.patch

    # https://github.com/AlexCSDev/PatreonDownloader/pull/286
    ./page-filter.patch
