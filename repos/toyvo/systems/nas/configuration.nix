...
in
{
  ...
  systemd.tmpfiles.rules = [
    ...
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.nextcloud}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.nextcloud}:rwx"
    "a /mnt/POOL/Collin - - - - u:${config.ids.uids.nextcloud}:rwx"
    "A /mnt/POOL/Collin - - - - u:${config.ids.uids.nextcloud}:rwx"
    "a /mnt/POOL/Chloe - - - - u:${config.ids.uids.nextcloud}:rwx"
    "A /mnt/POOL/Chloe - - - - u:${config.ids.uids.nextcloud}:rwx"
    "a /mnt/POOL/nextcloud - - - - u:${config.ids.uids.nextcloud}:rwx"
    "A /mnt/POOL/nextcloud - - - - u:${config.ids.uids.nextcloud}:rwx"
    "a /mnt/POOL/home-assistant - - - - u:${config.ids.uids.haas}:rwx"
    "A /mnt/POOL/home-assistant - - - - u:${config.ids.uids.haas}:rwx"
    "a /mnt/POOL/immich - - - - u:${config.ids.uids.immich}:rwx"
    "A /mnt/POOL/immich - - - - u:${config.ids.uids.immich}:rwx"
    "a /mnt/POOL/jellyfin - - - - u:${config.ids.uids.jellyfin}:rwx"
    "A /mnt/POOL/jellyfin - - - - u:${config.ids.uids.jellyfin}:rwx"
    "a /mnt/POOL/open-webui - - - - u:${config.ids.uids.open-webui}:rwx"
    "A /mnt/POOL/open-webui - - - - u:${config.ids.uids.open-webui}:rwx"

    # Starr services - need rwx for downloading and organizing media
    # Multimedia group (GID 349) - used by most *arr services
    "a /mnt/POOL/Public - - - - g:${config.ids.gids.multimedia}:rwx"
    "A /mnt/POOL/Public - - - - g:${config.ids.gids.multimedia}:rwx"
    "a /mnt/POOL/jellyfin - - - - g:${config.ids.gids.multimedia}:rwx"
    "A /mnt/POOL/jellyfin - - - - g:${config.ids.gids.multimedia}:rwx"
    "a /mnt/POOL/starr - - - - g:${config.ids.gids.multimedia}:rwx"
    "A /mnt/POOL/starr - - - - g:${config.ids.gids.multimedia}:rwx"
    # Individual starr service UIDs for explicit access
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.bazarr}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.bazarr}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.lidarr}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.lidarr}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.prowlarr}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.prowlarr}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.deluge}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.deluge}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.transmission}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.transmission}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.qbittorrent}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.qbittorrent}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.radarr}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.radarr}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.readarr}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.readarr}:rwx"
    "a /mnt/POOL/Public - - - - u:${config.ids.uids.sonarr}:rwx"
    "A /mnt/POOL/Public - - - - u:${config.ids.uids.sonarr}:rwx"
    "a /mnt/POOL/starr/bazarr - - - - u:${config.ids.uids.bazarr}:rwx"
    "A /mnt/POOL/starr/bazarr - - - - u:${config.ids.uids.bazarr}:rwx"
    "a /mnt/POOL/starr/lidarr - - - - u:${config.ids.uids.lidarr}:rwx"
    "A /mnt/POOL/starr/lidarr - - - - u:${config.ids.uids.lidarr}:rwx"
    "a /mnt/POOL/starr/prowlarr - - - - u:${config.ids.uids.prowlarr}:rwx"
    "A /mnt/POOL/starr/prowlarr - - - - u:${config.ids.uids.prowlarr}:rwx"
    "a /mnt/POOL/starr/deluge - - - - u:${config.ids.uids.deluge}:rwx"
    "A /mnt/POOL/starr/deluge - - - - u:${config.ids.uids.deluge}:rwx"
    "a /mnt/POOL/starr/transmission - - - - u:${config.ids.uids.transmission}:rwx"
    "A /mnt/POOL/starr/transmission - - - - u:${config.ids.uids.transmission}:rwx"
    "a /mnt/POOL/starr/qbittorrent - - - - u:${config.ids.uids.qbittorrent}:rwx"
    "A /mnt/POOL/starr/qbittorrent - - - - u:${config.ids.uids.qbittorrent}:rwx"
    "a /mnt/POOL/starr/radarr - - - - u:${config.ids.uids.radarr}:rwx"
    "A /mnt/POOL/starr/radarr - - - - u:${config.ids.uids.radarr}:rwx"
    "a /mnt/POOL/starr/readarr - - - - u:${config.ids.uids.readarr}:rwx"
    "A /mnt/POOL/starr/readarr - - - - u:${config.ids.uids.readarr}:rwx"
    "a /mnt/POOL/starr/sonarr - - - - u:${config.ids.uids.sonarr}:rwx"
    "A /mnt/POOL/starr/sonarr - - - - u:${config.ids.uids.sonarr}:rwx"
  ];
}
