...
let
  sources = {
    ...
    "terser-5.19.0" = {
      ...
      version = "5.19.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/terser/-/terser-5.19.0.tgz";
...
in
{
  ...
  "@rollup/plugin-commonjs" = nodeEnv.buildNodePackage {
    ...
    version = "25.0.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/@rollup/plugin-commonjs/-/plugin-commonjs-25.0.3.tgz";
