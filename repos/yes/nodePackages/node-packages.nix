...
let
  sources = {
    ...
    "@rollup/pluginutils-5.0.4" = {
      ...
      version = "5.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@rollup/pluginutils/-/pluginutils-5.0.4.tgz";
    ...
    "smob-1.4.0" = {
      ...
      version = "1.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/smob/-/smob-1.4.0.tgz";
    ...
    "url-0.11.2" = {
      ...
      version = "0.11.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/url/-/url-0.11.2.tgz";
        sha512 = "7yIgNnrST44S7PJ5+jXbdIupfU1nWUdQJBFBeJRclPXiWgCvrSq5Frw8lr/i//n5sqDfzoKmBymMS81l4U/7cg==";
      };
    };
...
in
{
  aria2b = nodeEnv.buildNodePackage {
    ...
    version = "1.0.8";
    src = fetchurl {
      url = "https://registry.npmjs.org/aria2b/-/aria2b-1.0.8.tgz";
      sha512 = "YDDfHBtOLb1frLISQMySAGgyZEq4JBXzzNflA6uEPh0M2NXb1f5XtBe3YhmjLdxIGHl0bngEh4d4bRvCEP2LVg==";
    };
    dependencies = [
  ...
  "shadowsocks-ws-git+https://github.com/totravel/shadowsocks-ws.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "969677e06d502dab6b0b2f17355ea648be1c2989";
      sha256 = "5240cb40ba7f122689da91d694084d1085d9025e9ed708b8662afe4900f6890c";
    };
    dependencies = [
  ...
  "@rollup/plugin-node-resolve" = nodeEnv.buildNodePackage {
    ...
    version = "15.2.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@rollup/plugin-node-resolve/-/plugin-node-resolve-15.2.1.tgz";
      sha512 = "nsbUg588+GDSu8/NS8T4UAshO6xeaOfINNuXeVHcKV02LJtoRaM1SiOacClw4kws1SFiNhdLGxlbMY9ga/zs/w==";
    };
    dependencies = [
      sources."@rollup/pluginutils-5.0.4"
  ...
  "@rollup/plugin-commonjs" = nodeEnv.buildNodePackage {
    ...
    version = "25.0.4";
    src = fetchurl {
      url = "https://registry.npmjs.org/@rollup/plugin-commonjs/-/plugin-commonjs-25.0.4.tgz";
      sha512 = "L92Vz9WUZXDnlQQl3EwbypJR4+DM2EbsO+/KOcEkP4Mc6Ct453EeDB2uH9lgRwj4w5yflgNpq9pHOiY8aoUXBQ==";
    };
    dependencies = [
