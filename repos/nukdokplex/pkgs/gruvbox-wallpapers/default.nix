pkgs:
let
  mkWallpapersDerivationConfig = wallpapersCategory: { pkgs, lib, fetchFromGitHub, stdenvNoCC, ... }: stdenvNoCC.mkDerivation {
  ...
  wallpapersCategories = [ "anime" "irl" "light" "minimalistic" "mix" "pixelart" "videogame-3d-art" ];
in
pkgs.lib.attrsets.genAttrs wallpapersCategories (wallpapersCategory: pkgs.callPackage (mkWallpapersDerivationConfig wallpapersCategory) { })
