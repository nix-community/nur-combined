...
SOPS_BIN: str = nixdata.sops_bin
DNS_SECRETS_FILE: str = nixdata.dns_secrets_file
DATA = nixdata.config
...
def req(path: str, **kwargs: str):
    ...
    return CLIENT.get(BASE_URL + path, params={**auth_params, **params}).json()
