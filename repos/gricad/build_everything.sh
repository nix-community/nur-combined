...
packages="hello irods irods-icommands hp2p obitools3 plplot openmpi openmpi1 openmpi2 openmpi2-opa openmpi2-ib openmpi3 openmpi4 petscComplex petscReal udocker arpackNG gmt szip mpi-ping hoppet applgrid stacks messer-slim fate migrate gdl fftw3 zonation-core scotch-mumps suitesparse hpl"
