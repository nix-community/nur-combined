{ lib, stdenv, fetchurl, fetchpatch, gfortran, perl, libnl, psm2, libfabric
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = with stdenv; [ gfortran zlib ]
    ...
    ++ [ libevent hwloc ]
    ++ lib.optional enableFabric [ psm2 libfabric ]
  ...
  configureFlags = with stdenv; lib.optional (!cudaSupport) "--disable-mca-dso"
    ...
    ++ lib.optional enableFabric [ "--with-psm2=${psm2} --with-libfabric=${libfabric}" ]
    ;
