...
def main():
    ...
    for pkg, pkg_path in iter_package_dirs():
            ...
            # wayback-machine-extension: pinned to master tip; release tags lag and would false-report
            if pkg in ['polkit', 'minetest580', 'minetest591', 'irrlichtmt', 'ogre-1_11', 'electron_castlabs_38', 'audacity4', 'ocaml-index', 'electron_36-bin', 'supertuxkart-evolution', 'tlottie', 'video-speed-controller-firefox', 'wayback-machine-extension'] or 'plugin' in pkg:
                continue
