...
def main():
    ...
    for pkg, pkg_path in iter_package_dirs():
            if pkg in ['polkit', 'minetest580', 'minetest591', 'irrlichtmt', 'ogre-1_11', 'electron_castlabs_38', 'audacity4', 'ocaml-index', 'electron_36-bin', 'supertuxkart-evolution'] or 'plugin' in pkg:
                continue
