...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    install -Dm644 "$jarFile" "$out/share/newpipe-native-wip/newpipe-native-wip.jar"

    install -Dm644 ${./icon.png} \
      "$out/share/icons/hicolor/192x192/apps/newpipe-native-wip.png"

    makeWrapper ${jdk21}/bin/java "$out/bin/newpipe-native-wip" \
      --add-flags "-jar $out/share/newpipe-native-wip/newpipe-native-wip.jar" \
  ...
  desktopItems = [
    (makeDesktopItem {
      ...
      startupWMClass = "newpipe-native-wip";
    })
  ];
  ...
  meta = {
    ...
    mainProgram = "newpipe-native-wip";
