...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.96.1 (31fca3adb 2026-06-26) (built from a source tarball)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.96.1 (31fca3adb 2026-06-26) (built from a source tarball)";
#[allow(clippy::needless_raw_string_hashes)]
