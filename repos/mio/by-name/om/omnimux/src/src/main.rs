...
fn main() {
    ...
    gpui::Application::new().run(move |cx: &mut gpui::App| {
        ...
        cx.bind_keys([
            ...
            KeyBinding::new("cmd-=", ZoomIn, Some("omnimux_terminal")),
            KeyBinding::new("ctrl-=", ZoomIn, Some("omnimux")),
            KeyBinding::new("ctrl-=", ZoomIn, Some("omnimux_terminal")),
            KeyBinding::new("ctrl-shift-=", ZoomIn, Some("omnimux")),
            KeyBinding::new("ctrl-shift-=", ZoomIn, Some("omnimux_terminal")),
            KeyBinding::new("cmd-plus", ZoomIn, Some("omnimux")),
            KeyBinding::new("cmd-plus", ZoomIn, Some("omnimux_terminal")),
            KeyBinding::new("ctrl-plus", ZoomIn, Some("omnimux")),
            KeyBinding::new("ctrl-plus", ZoomIn, Some("omnimux_terminal")),
            KeyBinding::new("cmd--", ZoomOut, Some("omnimux")),
            KeyBinding::new("cmd--", ZoomOut, Some("omnimux_terminal")),
            KeyBinding::new("ctrl--", ZoomOut, Some("omnimux")),
            KeyBinding::new("ctrl--", ZoomOut, Some("omnimux_terminal")),
            KeyBinding::new("cmd-0", ZoomReset, Some("omnimux")),
            KeyBinding::new("cmd-0", ZoomReset, Some("omnimux_terminal")),
            KeyBinding::new("ctrl-0", ZoomReset, Some("omnimux")),
            KeyBinding::new("ctrl-0", ZoomReset, Some("omnimux_terminal")),
