# We intend to keep a pinned resolve 20.3.3 before https://github.com/NixOS/nixpkgs/pull/536285
{
  stdenv,
  lib,
  cacert,
...
let
  davinci = (
    stdenv.mkDerivation rec {
      pname = "davinci-resolve2033${lib.optionalString studioVariant "-studio"}";
      version = "20.3.3";
