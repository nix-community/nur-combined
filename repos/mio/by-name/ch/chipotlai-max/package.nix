...
let
  node_modules =
    ...
    stdenv.mkDerivation {
      ...
      outputHash = "sha256-c76xMGTCS0YOV+vGdfMeRkBl8Zb97zHOjpmJMxym1tM=";
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "cyberpapiii";
    repo = "chipotlai-max";
    rev = "ba3ec39919621b73a732fce530c9f0b10fb4244b";
    hash = "sha256-5F4SBvpxVaPREVKGaog0eQI0YOTaAmTSnTprlQCh3kI=";
  ...
  installPhase = ''
    ...
    install -Dm755 dist/chipotlai-*/bin/opencode $out/bin/opencode
  ...
  meta = {
    description = "The AI coding agent that runs on stolen Chipotle compute";
    homepage = "https://github.com/cyberpapiii/chipotlai-max";
