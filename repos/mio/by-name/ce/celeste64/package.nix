# Vendored from nixpkgs ac6b2166e7a9. See README.md (repo root sources section).
{
  lib,
  stdenv,
  buildDotnetModule,
...
buildDotnetModule rec {
  ...
  # Foster ships a self-contained osx dylib (system frameworks only). Linux needs SDL/GL/etc.
