...
buildDotnetModule rec {
  ...
  preFixup = ''
    ...
    ${lib.optionalString stdenv.hostPlatform.isDarwin ''
      ...
      cp ${src}/distribution/linux/Ryujinx.desktop $out/share/applications/Ryujinx.desktop
      substituteInPlace $out/share/applications/Ryujinx.desktop \
        --replace-warn "Exec=Ryujinx.sh %f" "Exec=Ryujinx"
      cp ${src}/distribution/misc/Logo.svg $out/share/icons/hicolor/scalable/apps/Ryujinx.svg
    ''}
