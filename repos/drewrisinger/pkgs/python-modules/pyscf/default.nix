...
buildPythonPackage rec {
  ...
  doCheck = false;  # tests fail, and I just don't care enough about this package to diagnose them. I'm happy to accept PRs though.
  ...
  meta = with lib; {
    ...
    # maintainers = [ maintainers.sheepforce ]; # not present in nixos-21.05
  };
}
