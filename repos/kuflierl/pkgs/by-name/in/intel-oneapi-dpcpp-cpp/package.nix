{ lib, stdenv, python3, cmake, ninja, fetchFromGitHub, level-zero-1-19, intel-compute-runtime-24-39-31294-12, oneapi-unified-memory-framework, opencl-headers }:
let
...
stdenv.mkDerivation rec {
  ...
  configurePhase = ''
    ...
    python3 buildbot/configure.py \
      ...
      -DUR_OPENCL_INCLUDE_DIR="${opencl-headers}/include"
  '';
