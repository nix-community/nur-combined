...
let
  sources = {
    ...
    "electron-3.1.12" = {
      ...
      version = "3.1.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron/-/electron-3.1.12.tgz";
        sha512 = "3OfvhzD7gJlSKgsvKFxHNzZpG0rt8qwRqP07rSKKQU+TdLl7NkWAdWFVqhkebdj6QgnxOJffZDkosva67KZjRA==";
      };
    };
