...
let
  sources = {
    ...
    "@types/node-14.0.10" = {
      ...
      version = "14.0.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-14.0.10.tgz";
        sha512 = "Bz23oN/5bi0rniKT24ExLf4cK0JdvN3dH/3k0whYkdN4eI4vS2ZW/2ENNn2uxHCzWcbdHIa/GRuWQytfzCjRYw==";
      };
    };
    "agent-base-4.2.1" = {
      name = "agent-base";
    ...
    "aws-sdk-2.690.0" = {
      ...
      version = "2.690.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.690.0.tgz";
        sha512 = "KZasSKw/nKVA+LnOCaccGbFZ9eLDTz7oDc/6IYp9lbvN+XrdCBb8cQveDX3N9i4uDS2G5nz/47UxtP+MYMBynQ==";
      };
    };
