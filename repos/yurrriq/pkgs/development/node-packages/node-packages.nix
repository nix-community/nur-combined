  ...
  sources = {
    ...
    "@types/node-8.10.53" = {
      ...
      src = fetchurl {
        ...
        sha512 = "aOmXdv1a1/vYUn1OT1CED8ftbkmmYbKhKGSyMDeJiidLvKRKvZUQOdXwG/wcNY7T1Qb0XTlVdiYjIq00U7pLrQ==";
      };
    };
    "agent-base-4.2.1" = {
      name = "agent-base";
    ...
    "aws-sdk-2.523.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "x6Bam0TSG5wnn1QaBUj+Cg4Tde+xyHe35V/G58bXyhwybhrTl2ffBBFeMnO1jvmHa9aEN9p3FV2jn43e2vouZg==";
      };
    };
