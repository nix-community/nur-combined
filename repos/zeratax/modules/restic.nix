...
let
  ...
  unitOption = (import ./nixos/systemd-unit-options.nix { inherit config lib; }).unitOption;
in
{
    ...
    type = types.attrsOf (types.submodule ({ name, ... }: {
      options = {
        ...
        preStart = mkOption {
          ...
          '';
          example = "program-that-saves-alot pause";
        };
        ...
        postStart = mkOption {
          ...
          '';
          example = "program-that-saves-alot continue";
        };
      };
    }));
    default = {};
