...
{pkgs, ...}: {
  workspaceMembers."wsrx-desktop".build = pkgs.runCommand "wsrx-desktop-placeholder" {meta = {};} ''
    echo "pkgs/wsrx-desktop/Cargo.nix is a placeholder; run the update workflow to regenerate it" >&2
    false
  '';
}
