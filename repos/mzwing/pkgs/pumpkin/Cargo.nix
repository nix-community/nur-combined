  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "blocking" "charset" "default" "default-tls" "http2" "json" "rustls" "system-proxy" ];
      };
      "rfc6979 0.4.0" = rec {
        crateName = "rfc6979";
        version = "0.4.0";
