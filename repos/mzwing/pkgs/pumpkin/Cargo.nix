  ...
  internal = rec {
    ...
    crates = {
      ...
      "wit-encoder" = rec {
        ...
        version = "0.256.0";
        edition = "2024";
        sha256 = "1423n9adhmk2jgvdmg2fap19zsr1y7cbk2alky7w9a2gf8g5l25q";
        libName = "wit_encoder";
        dependencies = [
          {
            name = "id-arena";
      ...
      "wit-parser 0.256.0" = rec {
        crateName = "wit-parser";
        version = "0.256.0";
        edition = "2024";
        sha256 = "1a807aggv6vhm7m0gfc6py1zhlgw7qp0r6k87yq9r1dsxynks1zs";
        libName = "wit_parser";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
