...
in
{
  ...
  "unknown".cfg."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    devDependencies = {
      expect_test = rustPackages."registry+https://github.com/rust-lang/crates.io-index".expect-test."1.0.2" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.43.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-derive";
    version = "0.43.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e2d9e0c8adcced1ab0fea5cb8a38647922893d5b495e363e1814299fd380469b"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.43.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-ir";
    version = "0.43.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c5218266a5709bc4943de997e64d3fab41c9e9f68efd54a898de53135e987bd3"; };
    dependencies = {
      chalk_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.43.0" { profileName = "__noProfile"; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".chalk-recursive."0.43.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-recursive";
    version = "0.43.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ed8f34f13fd4f30251f9f6f1dc56f80363201390ecbcac2fdfc8e33036cd9c4a"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
      chalk_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.43.0" { profileName = "__noProfile"; };
      chalk_ir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.43.0" { inherit profileName; };
      chalk_solve = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.43.0" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.22" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.43.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-solve";
    version = "0.43.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "379c9f584488346044709d4c638c38d61a06fe593d4de2ac5f15fd2b0ba4cd9d"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "tracing-full" ]
      [ "tracing-subscriber" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".expect-test."1.0.2" = overridableMkRustCrate (profileName: rec {
    name = "expect-test";
    version = "1.0.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "eab78d4c727fa879de40951ffc01ed781a231b28786b19d6bfbdc0d1ec92eb3e"; };
    dependencies = {
  ...
  "unknown".hir_ty."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      base_db = rustPackages."unknown".base_db."0.0.0" { inherit profileName; };
      chalk_ir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.43.0" { inherit profileName; };
      chalk_recursive = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-recursive."0.43.0" { inherit profileName; };
      chalk_solve = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.43.0" { inherit profileName; };
      ena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ena."0.14.0" { inherit profileName; };
      hir_def = rustPackages."unknown".hir_def."0.0.0" { inherit profileName; };
      hir_expand = rustPackages."unknown".hir_expand."0.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.85.0" = overridableMkRustCrate (profileName: rec {
    name = "lsp-types";
    version = "0.85.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "857650f3e83fb62f89d15410414e0ed7d0735445020da398d37f65d20a5423b9"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "proposed" ]
    ];
  ...
  "unknown".rust-analyzer."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rust-analyzer" then "lsp_types" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.85.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ungrammar."1.4.0" = overridableMkRustCrate (profileName: rec {
    name = "ungrammar";
    version = "1.4.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "68951379f3ced25754472ca5addbf74d7dab58c9818f49290a3d8caa3ab44fb7"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".xshell."0.1.7" = overridableMkRustCrate (profileName: rec {
    name = "xshell";
    version = "0.1.7";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ed0728d188f2ae530490b7d92435728aba53c6aed06d07e1951da9bd4c1d0798"; };
    dependencies = {
      xshell_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".xshell-macros."0.1.7" { profileName = "__noProfile"; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".xshell-macros."0.1.7" = overridableMkRustCrate (profileName: rec {
    name = "xshell-macros";
    version = "0.1.7";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "367f903cc3f8bc4f4b2400d47dfa6c9e3e121ffb51a30cf0fb67a72c0a0f9617"; };
  });
  ...
  "unknown".xtask."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.24" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      ungrammar = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ungrammar."1.4.0" { inherit profileName; };
      walkdir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".walkdir."2.3.1" { inherit profileName; };
      write_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".write-json."0.1.2" { inherit profileName; };
      xshell = rustPackages."registry+https://github.com/rust-lang/crates.io-index".xshell."0.1.7" { inherit profileName; };
    };
  });
