...
stdenv.mkDerivation (
  ...
  let
    electron41Patch = fetchpatch2 {
      url = "https://github.com/eugeny/tabby/commit/58c316f0f3dec62fa3ee0906c8a4876bcb671c40.patch";
      hash = "sha256-zcQaFe+cFjWIPvZoLKHHQ+dm+0tgPQN4EGJKRO0b8mM=";
    };
  ...
  in
  {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-9pqgj5v6uZLau2X9RMB5YI7qZ+gELwvxc7m9eI/RuEI=";
