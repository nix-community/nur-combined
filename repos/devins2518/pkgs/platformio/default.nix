{ lib, python3Packages, fetchFromGitHub, fetchpatch, installShellFiles, git
, spdx-license-list-data, substituteAll }:
...
buildPythonApplication rec {
  ...
  patches = [
    (substituteAll {
      ...
      interpreter = (python3Packages.python.withPackages
        (_: propagatedBuildInputs)).interpreter;
    })
    (substituteAll {
  ...
  nativeBuildInputs = [ installShellFiles pythonRelaxDepsHook setuptools ];
