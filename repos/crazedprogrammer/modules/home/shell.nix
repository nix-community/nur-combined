...

{
  ...
  programs.fish = {
    ...
    shellAliases = {
      ...
      ros = "xhost +; docker run -e DISPLAY=$DISPLAY --device /dev/dri -v /tmp/.X11-unix:/tmp/.X11-unix -v $HOME/.Xauthority:/home/casper/.Xauthority -v $PWD:/pwd --rm -it ros:melodic-robot-custom";
