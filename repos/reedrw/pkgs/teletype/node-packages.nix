...
let
  sources = {
    ...
    "@types/node-10.17.49" = {
      ...
      version = "10.17.49";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-10.17.49.tgz";
        sha512 = "PGaJNs5IZz5XgzwJvL/1zRfZB7iaJ5BydZ8/Picm+lUNYoNO9iVTQkVy5eUh0dZDrx3rBOIs3GCbCRmMuYyqwg==";
      };
    };
    "ajv-6.12.6" = {
      name = "ajv";
