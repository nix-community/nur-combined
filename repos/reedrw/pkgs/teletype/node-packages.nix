...
let
  sources = {
    ...
    "@types/node-10.17.41" = {
      ...
      version = "10.17.41";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-10.17.41.tgz";
        sha512 = "nKJyZS0+HGPXNAKPh2egQbsXHZvDbeQEb7JT667+4cTO6n+VSZ9kl9AqL0XxRhL9YP4HWfw/EGTA9ajOWMzL3A==";
      };
    };
    "ajv-6.12.6" = {
      name = "ajv";
