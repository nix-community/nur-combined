...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 6.8.39 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `ela-widget-tools` | [ela-widget-tools](https://github.com/Liniyous/ElaWidgetTools) | 0-unstable-2026-03-01 | Fluent-UI For QT-Widget |
...
|  | `rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr13.3.1.4-unstable-2026-03-02 | Sipwise media proxy for Kamailio |
...
|  | `runpodctl` | [runpodctl](https://www.runpod.io) | 2.1.3 | RunPod CLI for pod management |
...
|  | `xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr13.3.1.4-unstable-2026-03-02 | Sipwise media proxy for Kamailio (kernel module) |
...
|  | `kernel-modules.xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr13.3.1.4-unstable-2026-03-02 | Sipwise media proxy for Kamailio (kernel module) |
</details>
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 8189 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 6.8.39 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.ela-widget-tools` | [ela-widget-tools](https://github.com/Liniyous/ElaWidgetTools) | 0-unstable-2026-03-01 | Fluent-UI For QT-Widget |
...
|  | `uncategorized.rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr13.3.1.4-unstable-2026-03-02 | Sipwise media proxy for Kamailio |
|  | `uncategorized.runpodctl` | [runpodctl](https://www.runpod.io) | 2.1.3 | RunPod CLI for pod management |
