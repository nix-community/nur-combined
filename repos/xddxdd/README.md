...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.51 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `new-api` | [new-api](https://github.com/QuantumNous/new-api) | 1.0.0-rc.18 | AI model gateway for aggregation and distribution, supports converting LLMs into OpenAI-compatible, Claude-compatible, or Gemini-compatible formats |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2026-07-06 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 9891 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.51 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.new-api` | [new-api](https://github.com/QuantumNous/new-api) | 1.0.0-rc.18 | AI model gateway for aggregation and distribution, supports converting LLMs into OpenAI-compatible, Claude-compatible, or Gemini-compatible formats |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2026-07-06 | Unifies the management of LLM APIs across multiple backend services |
