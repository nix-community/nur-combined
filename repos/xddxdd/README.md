...
|  | `mages-bin` | [mages-bin](https://github.com/mlm-games/Mages) | 4.11.1 | Experimental Matrix chat client built with Compose Multiplatform and matrix-rust-sdk |
...
|  | `uncategorized.mages-bin` | [mages-bin](https://github.com/mlm-games/Mages) | 4.11.1 | Experimental Matrix chat client built with Compose Multiplatform and matrix-rust-sdk |
