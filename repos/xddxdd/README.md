...
|  | `bifrost` | [bifrost](https://github.com/maximhq/bifrost) | 1.6.0 | High-performance AI gateway with unified OpenAI-compatible API |
...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.41 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `command-code` | [command-code](https://github.com/CommandCodeAI/command-code) | 0.40.8 | Coding agent that continuously learns your coding taste |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2026-06-25 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
|  | `geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.06.25 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2026-06-24 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `pterodactyl-wings` | [pterodactyl-wings](https://pterodactyl.io) | 1.13.0-unstable-2026-06-22 | Server control plane for Pterodactyl Panel |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-06-26 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr26.0.1.14-unstable-2026-06-24 | Sipwise media proxy for Kamailio |
...
|  | `runpodctl` | [runpodctl](https://www.runpod.io) | 2.6.0 | RunPod CLI for pod management |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2026-06-25 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr26.0.1.14-unstable-2026-06-24 | Sipwise media proxy for Kamailio (kernel module) |
...
|  | `kernel-modules.xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr26.0.1.14-unstable-2026-06-24 | Sipwise media proxy for Kamailio (kernel module) |
</details>
...
|  | `lantianCustomized.attic-telnyx-compatible` | [attic](https://github.com/zhaofengli/attic) | 0-unstable-2026-06-14 | Multi-tenant Nix Binary Cache |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 9789 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2026-06-25 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `uncategorized.bifrost` | [bifrost](https://github.com/maximhq/bifrost) | 1.6.0 | High-performance AI gateway with unified OpenAI-compatible API |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.41 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.command-code` | [command-code](https://github.com/CommandCodeAI/command-code) | 0.40.8 | Coding agent that continuously learns your coding taste |
...
|  | `uncategorized.geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.06.25 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `uncategorized.liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2026-06-24 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `uncategorized.pterodactyl-wings` | [pterodactyl-wings](https://pterodactyl.io) | 1.13.0-unstable-2026-06-22 | Server control plane for Pterodactyl Panel |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-06-26 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uncategorized.rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr26.0.1.14-unstable-2026-06-24 | Sipwise media proxy for Kamailio |
|  | `uncategorized.runpodctl` | [runpodctl](https://www.runpod.io) | 2.6.0 | RunPod CLI for pod management |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2026-06-25 | Unifies the management of LLM APIs across multiple backend services |
