...
|  | `qemu-user-static` | [qemu-user-static](http://www.qemu.org/) | 9.2.0+ds-1 | Generic and open source machine emulator and virtualizer |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2024-12-14 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 4326 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `uncategorized.qemu-user-static` | [qemu-user-static](http://www.qemu.org/) | 9.2.0+ds-1 | Generic and open source machine emulator and virtualizer |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2024-12-14 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
