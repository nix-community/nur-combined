...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 6.9.25 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.04.13 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2026-04-14 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr13.5.1.9-unstable-2026-04-10 | Sipwise media proxy for Kamailio |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2026-04-13 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr13.5.1.9-unstable-2026-04-10 | Sipwise media proxy for Kamailio (kernel module) |
...
|  | `kernel-modules.xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr13.5.1.9-unstable-2026-04-10 | Sipwise media proxy for Kamailio (kernel module) |
</details>
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 8792 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 6.9.25 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.04.13 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `uncategorized.liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2026-04-14 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `uncategorized.rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr13.5.1.9-unstable-2026-04-10 | Sipwise media proxy for Kamailio |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2026-04-13 | Unifies the management of LLM APIs across multiple backend services |
