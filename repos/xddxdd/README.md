...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | unstable-2024-05-31 | Rime 配置：雾凇拼音 | 长期维护的简体词库  |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 3058 | Port of Facebook's LLaMA model in C/C++ |
...
|  | `nvidia-grid.grid.15_4` | [nvidia-x11-525.147.05-6.6.32](https://www.nvidia.com/object/unix.html) | 525.147.05 | NVIDIA vGPU guest driver (GRID driver, experimental package) |
...
|  | `nvidia-grid.guest.15_4` | [nvidia-x11-525.147.05-6.6.32](https://www.nvidia.com/object/unix.html) | 525.147.05 | NVIDIA vGPU guest driver (GRID driver, experimental package) |
...
|  | `nvidia-grid.host.15_4` | [nvidia-x11-525.147.01-6.6.32](https://www.nvidia.com/object/unix.html) | 525.147.01 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) |
...
|  | `nvidia-grid.vgpu.15_4` | [nvidia-x11-525.147.01-6.6.32](https://www.nvidia.com/object/unix.html) | 525.147.01 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) |
