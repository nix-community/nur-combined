...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-04-29 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
| `Broken` `x86_64-linux` | `piliplus` | [piliplus](https://github.com/bggRGjQaUbCoE/PiliPlus) | 1.1.3.32 | Third party Bilibili client built with Flutter |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 5216 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-04-29 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
| `Broken` `x86_64-linux` | `uncategorized.piliplus` | [piliplus](https://github.com/bggRGjQaUbCoE/PiliPlus) | 1.1.3.32 | Third party Bilibili client built with Flutter |
