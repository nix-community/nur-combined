...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 5608 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `lantianCustomized.telegram-desktop` | [telegram-desktop](https://desktop.telegram.org/) | 5.15.2 | Telegram Desktop messaging app (Without anti-features) |
