...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | unstable-2024-07-30 | Rime 配置：雾凇拼音 | 长期维护的简体词库  |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 3489 | Port of Facebook's LLaMA model in C/C++ |
