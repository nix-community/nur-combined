...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.37 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `command-code` | [command-code](https://github.com/CommandCodeAI/command-code) | 0.40.6 | Coding agent that continuously learns your coding taste |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2026-06-24 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-06-24 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 9784 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2026-06-24 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.37 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.command-code` | [command-code](https://github.com/CommandCodeAI/command-code) | 0.40.6 | Coding agent that continuously learns your coding taste |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-06-24 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
