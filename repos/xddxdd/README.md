...
|  | `liboqs` | [liboqs](https://openquantumsafe.org) | unstable-2024-06-05 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
<details>
<summary>Package set: nvidia-grid (104 packages)</summary>
