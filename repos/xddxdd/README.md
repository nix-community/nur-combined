...
| `Broken` | `boringssl-oqs` | [boringssl-oqs](https://openquantumsafe.org) | unstable-2024-08-13 | Fork of BoringSSL that includes prototype quantum-resistant key exchange and authentication in the TLS handshake based on liboqs |
