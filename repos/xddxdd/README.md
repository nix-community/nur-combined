...
|  | `inter-knot` | [inter-knot](https://inot.top) | 2.16.7+34 | 绳网是一个游戏、技术交流平台 |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 3763 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
