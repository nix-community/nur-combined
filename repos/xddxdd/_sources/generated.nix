...
}:
{
  ...
  cliproxyapi = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "CLIProxyAPI";
      tag = "v7.1.24";
      hash = "sha256-23k5XutJsXSv8TjuRPx0QnZK9vk7Ydz26surqYjy398=";
    };
  };
  cockpy = {
    pname = "cockpy";
  ...
  command-code = {
    ...
    version = "0.28.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/command-code/-/command-code-0.28.1.tgz";
      hash = "sha256-suMcDx0n1I5yYsyzwKHe7KXVG+F/NJ0mFnyFDkrVruI=";
    };
  };
  comp128 = {
    pname = "comp128";
  ...
  flapalerted = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "FlapAlerted";
      tag = "v4.4.2";
      hash = "sha256-egNrqSCMndD55hgerhgpHHhT8fOZteKoZE6d6EbDxik=";
    };
  };
  flaresolverr-21hsmw = {
  ...
  funasr = {
    pname = "funasr";
    version = "a8d23eecbb45ca508c0fc974b23785b20e2ab6f1";
    src = fetchFromGitHub {
      owner = "modelscope";
      repo = "FunASR";
      rev = "a8d23eecbb45ca508c0fc974b23785b20e2ab6f1";
      hash = "sha256-qtSDO8gElKHxz6UMWTuXxnrnQxRefCJyW3GhEXotS50=";
    };
    date = "2026-05-28";
  };
  geolite2-asn = {
  ...
  llama-cpp = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "llama.cpp";
      tag = "b9370";
      hash = "sha256-FsS2OfEo4KLgV9U9KBK0g+WVBZpWLNUuFB5xTp+YDBU=";
    };
  };
  loralib = {
    pname = "loralib";
  ...
  rtpengine = {
    pname = "rtpengine";
    version = "3285aec607e0bdf093f03b83dd899a8453deb28f";
    src = fetchFromGitHub {
      owner = "sipwise";
      repo = "rtpengine";
      rev = "3285aec607e0bdf093f03b83dd899a8453deb28f";
      hash = "sha256-ZYZTeZBaAMWqOaE93JApEaQAFoU3cr/poM/ezu3EnQc=";
    };
    date = "2026-05-27";
  };
  rtpengine-stable = {
