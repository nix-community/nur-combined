...
}:
{
  ...
  browser360-amd64 = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-OwU8ELtmyzg1UGAis/EdFpMPfZm3qyqV53OPoI2iILM=";
    };
  };
  browser360-arm64 = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-jeguR8HoZz+1TyS6/RCcPPrGQH2Etwq7m3ngBwGdDrU=";
    };
  };
  calibre-cops = {
    pname = "calibre-cops";
  ...
  cliproxyapi = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "CLIProxyAPI";
      tag = "v6.9.27";
      hash = "sha256-w08SIsZHa7XbUJu6U9f8qj9okZrrB+tV3YCShfWZJVk=";
    };
  };
  cockpy = {
    pname = "cockpy";
  ...
  geolite2-asn = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-Azc1sLBPlyhhPG2/5eGe6l4f57W/LSqlYA3Yh/DMj+8=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    ...
    src = fetchurl {
      ...
      hash = "sha256-FYURhxLA16pLFzKb0KrrVVEzM+tKdaquTVzJORiNnLU=";
    };
  };
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-jVfhbJTHeyEAqD1fmwQeR+4BkwilFq+jCkGYiNs8cnw=";
    };
  };
  glauth = {
    pname = "glauth";
  ...
  rtpengine = {
    pname = "rtpengine";
    version = "88f0483c4e0cb787fa72440f4c9afd982b23f773";
    src = fetchFromGitHub {
      owner = "sipwise";
      repo = "rtpengine";
      rev = "88f0483c4e0cb787fa72440f4c9afd982b23f773";
      hash = "sha256-r0rPq8KSu21i4sBOWwrPtF/zB3CHW0xpJt2jZwF4R00=";
    };
    date = "2026-04-14";
  };
  rtpengine-stable = {
  ...
  uni-api = {
    pname = "uni-api";
    version = "6c77247b4ca6bd0de0eadf156fe944600e06cc78";
    src = fetchFromGitHub {
      owner = "yym68686";
      repo = "uni-api";
      rev = "6c77247b4ca6bd0de0eadf156fe944600e06cc78";
      fetchSubmodules = true;
      hash = "sha256-2QNxDnctpYzP4hvkqiNueUa18RQFChAyyqgUF/Gn/0w=";
    };
    date = "2026-04-15";
  };
  unigine-heaven = {
