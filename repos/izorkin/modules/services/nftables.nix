...
in
{
  ...
  options = {
    networking.nftables2.enable = mkOption {
      type = types.bool;
      default = false;
      description =
        ''
    ...
    networking.nftables2.package = mkOption {
      default = pkgs.nftables;
      type = types.package;
    };
    networking.nftables2.ruleset = mkOption {
      type = types.lines;
      example = ''
    ...
    networking.nftables2.rulesetFile = mkOption {
      type = types.path;
