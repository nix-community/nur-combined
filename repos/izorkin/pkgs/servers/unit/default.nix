...
in {
  unitStable = generic {
    version = "1.6-1";
    name = "unit-1.6-1";
    sha256 = "1x53q3px7ih1jyh5a3jr5nm9ynzcs2w8ka9lr4c5l6xq4xarymh9";
  };

  unitUnstable = generic {
    version = "aeb026c";
    name = "unit-2018.12.12";
    sha256 = "01vjija2p3nh7ic3vjppb4z8njf742445mzq4wh6b8yizskbmwx2";
  };
}
