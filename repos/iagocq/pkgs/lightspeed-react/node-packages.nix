...
let
  sources = {
    ...
    "dom-accessibility-api-0.5.7" = {
      ...
      version = "0.5.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/dom-accessibility-api/-/dom-accessibility-api-0.5.7.tgz";
    ...
    "eslint-plugin-flowtype-5.9.1" = {
      ...
      version = "5.9.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-flowtype/-/eslint-plugin-flowtype-5.9.1.tgz";
        sha512 = "ncUBL9lbhrcOlM5p6xQJT2c0z9co/FlP0mXdva6FrkvtzOoN7wdc8ioASonEpcWffOxnJPFPI8N0sHCavE6NAg==";
      };
    };
    ...
    "eslint-plugin-react-7.25.0" = {
      ...
      version = "7.25.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-react/-/eslint-plugin-react-7.25.0.tgz";
        sha512 = "bZL+HeB+Qaimb4ryOc+OYYOX0XnOr6FX30ZXkzL8iSJA3tATTtZ1YgYyjK3jGvVDcZMejfUaeS/5wKDfTgyfVw==";
      };
    };
    ...
    "loadjs-4.2.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "AgQGZisAlTPbTEzrHPb6q+NYBMD+DP9uvGSIjSUM5uG+0jG15cb8axWpxuOIqrmQjn6scaaH8JwloiP27b2KXA==";
      };
    };
    "locate-path-2.0.0" = {
      name = "locate-path";
    ...
    "plyr-3.6.8" = {
      ...
      version = "3.6.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/plyr/-/plyr-3.6.8.tgz";
        sha512 = "Iu9KKsH+/HH6PBGAag57KswjXRXyJ9TeMlcMiwLCGC9foqSIb+crPi6wTmyFr9AFmTr8QZuFrYEL+SlnXT+vBw==";
      };
    };
    ...
    "rangetouch-2.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "sln+pNSc8NGaHoLzwNBssFSf/rSYkqeBXzX1AtJlkJiUaVSJSbRAWJk+4omsXkN+EJalzkZhWQ3th1m0FpR5xA==";
      };
    };
    "raw-body-2.4.0" = {
      name = "raw-body";
    ...
    "styled-components-5.3.1" = {
      ...
      version = "5.3.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/styled-components/-/styled-components-5.3.1.tgz";
        sha512 = "JThv2JRzyH0NOIURrk9iskdxMSAAtCfj/b2Sf1WJaCUsloQkblepy1jaCLX/bYE+mhYo3unmwVSI9I5d9ncSiQ==";
      };
    };
    "stylehacks-4.0.3" = {
      name = "stylehacks";
...
in
{
  "lightspeed-react-git://github.com/GRVYDEV/Lightspeed-react.git" = nodeEnv.buildNodePackage {
    name = "lightspeed-react";
    packageName = "lightspeed-react";
    version = "0.1.0";
    src = fetchgit {
    ...
    dependencies = [
      ...
      sources."dom-accessibility-api-0.5.7"
      ...
      sources."eslint-plugin-flowtype-5.9.1"
      ...
      (sources."eslint-plugin-react-7.25.0" // {
        dependencies = [
          sources."doctrine-2.1.0"
          sources."estraverse-5.2.0"
