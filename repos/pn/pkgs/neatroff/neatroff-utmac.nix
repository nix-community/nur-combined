...
let
  ...
  utmac = fetchFromGitHub {
    repo = "utmac";
    owner = "pjfichet";
    rev = "59c9d868a95843a9b0e70ace0f8bb8922cf3fad4";
    sha256 = "sha256:0871ggbr2bfbhwz250pyniiah2jfhzjdqjj07gpfz16s91wgwqgl";
  };
in
  stdenv.mkDerivation {
    name = "neatroff-utmac";
